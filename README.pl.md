...
# Windows (kompilacja i instalacja jednym kliknięciem z klonu)
...
> Pakiety Homebrew, Scoop, Chocolatey, Nix, Arch (AUR) i mise nie są jeszcze opublikowane.
...
CloseCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases) lub z [github.com/reubenzhuyt-cloud/CloseCode/releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases).
...
CloseCode zawiera dwóch wbudowanych agentów, między którymi możesz przełączać się klawiszem `Tab`.
...
Więcej informacji o konfiguracji CloseCode znajdziesz w [**dokumentacji**](https://opencode.ai/docs).

### Współtworzenie

Jeśli chcesz współtworzyć CloseCode, przeczytaj [contributing docs](./CONTRIBUTING.md) przed wysłaniem pull requesta.

### Budowanie na CloseCode

Jeśli pracujesz nad projektem związanym z CloseCode i używasz "opencode" jako części nazwy (na przykład "opencode-dashboard" lub "opencode-mobile"), dodaj proszę notatkę do swojego README, aby wyjaśnić, że projekt nie jest tworzony przez zespół CloseCode i nie jest z nami w żaden sposób powiązany.
