...
# Windows (byg og installer med ét klik fra et klon)
.\script\install-closecode.ps1

# macOS / Linux (fra et klon)
./install
...
> Homebrew-, Scoop-, Chocolatey-, Nix-, Arch (AUR)- og mise-pakker er endnu ikke udgivet.
...
CloseCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/reubenzhuyt-cloud/CloseCode/releases) eller [github.com/reubenzhuyt-cloud/CloseCode/releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases).
...
CloseCode har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
For mere info om konfiguration af CloseCode, [**se vores docs**](https://opencode.ai/docs).

### Bidrag

Hvis du vil bidrage til CloseCode, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på CloseCode

Hvis du arbejder på et projekt der er relateret til CloseCode og bruger "opencode" som en del af navnet; f.eks. "opencode-dashboard" eller "opencode-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af CloseCode-teamet og ikke er tilknyttet os på nogen måde.
