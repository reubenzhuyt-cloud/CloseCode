...
export const Info = Schema.Struct({
  ...
  toolset: Schema.Record(Schema.String, Schema.Boolean).pipe(optional),
  skillActivation: Schema.Record(Schema.String, Schema.Literals(["off", "name", "full"])).pipe(optional),
})
