...
export const dict = {
  ...
  "desktop.cli.installed.message":
    "CLI, {{path}} konumuna yüklendi.\n\n'closecode' komutunu kullanmak için terminalinizi yeniden başlatın.",
  ...
  "desktop.recovery.loadFailed": "CloseCode yüklenemedi",
  "desktop.recovery.terminated": "CloseCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "CloseCode yanıt vermiyor",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CloseCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak CloseCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CloseCode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CloseCode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode kontrol ediliyor…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde CloseCode kontrol ediliyor…",
  "wsl.onboarding.updatingOpencode": "CloseCode güncelleniyor…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde CloseCode güncelleniyor…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki CloseCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "CloseCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde CloseCode hazır.",
  "wsl.onboarding.opencodeReady": "CloseCode hazır.",
  "wsl.onboarding.installOpencodeIn": "CloseCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "CloseCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CloseCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "CloseCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından CloseCode'u tekrar açın.",
  ...
  "toast.update.description": "CloseCode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CloseCode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: CloseCode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CloseCode Masaüstü",
  ...
  "settings.desktop.wsl.description": "CloseCode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CloseCode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "CloseCode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CloseCode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CloseCode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CloseCode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CloseCode'un en son sürümünü kullanıyorsunuz.",
  ...
  "server.row.incompatible":
    "Bu sunucu, bu uygulamayla uyumlu olmayan CloseCode {{version}} sürümünü çalıştırıyor. Devam etmek için CloseCode V2'ye yükseltin.",
  ...
  "session.error.incompatible.description":
    "{{server}}, bu uygulamayla uyumlu olmayan CloseCode {{version}} sürümünü çalıştırıyor. Devam etmek için sunucuyu CloseCode V2'ye yükseltin.",
  ...
  "settings.about.description": "CloseCode, açık kaynak kodlama aracısı",
  "settings.about.trademark": "CloseCode, Anomaly Innovations, Inc.'in tescilli ticari markasıdır.",
  ...
  "ssh.stage.checking": "CloseCode kontrol ediliyor…",
  "ssh.stage.downloading": "Sunucu indiriliyor…",
  "ssh.stage.uploading": "Sunucu yükleniyor…",
  "ssh.stage.starting": "CloseCode'ye bağlanılıyor…",
  ...
  "ssh.error.service": "SSH bağlandı ancak CloseCode sunucusu hazır olmadı.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Kameranızı closecode pair tarafından gösterilen QR koduna doğrultun.",
  "server.connect.scan.invalid":
    "Bu bir CloseCode eşleştirme kodu değildir. closecode pair tarafından gösterilen kodu tarayın.",
  ...
  "project.settings.name.description": "CloseCode genelinde bu proje için gösterilen ad",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode tarafından kullanılabilen MCPs burada görünecek",
  "project.settings.extensions.empty.plugins.title": "Henüz eklenti yok",
  "project.settings.extensions.empty.plugins.description": "CloseCode'de kullanılabilen eklentiler burada görünecek",
  "project.settings.extensions.empty.skills.title": "Henüz beceri yok",
  "project.settings.extensions.empty.skills.description": "CloseCode'nin kullanabileceği beceriler burada görünecek",
  ...
  "settings.workspaces.empty.description": "CloseCode'de oluşturulan çalışma ağaçları burada görünecek",
  ...
  "settings.updates.action.download": "CloseCode’u indir",
  "settings.updates.migration.title": "Beta’dan Kararlı’ya geç",
  "settings.updates.migration.description":
    "CloseCode Beta şimdilik CloseCode Stable’a taşınıyor. Güncellemeleri almaya devam etmek için {{version}} sürümünü indirin, ardından CloseCode’u disk görüntüsünden yükleyin.",
