export const dict = {
  ...
  "desktop.recovery.loadFailed": "CloseCode መጫን አልቻለም",
  "desktop.recovery.terminated": "CloseCode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "CloseCode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "CloseCodeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "CloseCode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በCloseCode",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በCloseCode ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "CloseCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በCloseCode ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በCloseCode ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው CloseCode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "CloseCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ…",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ CloseCode በ{{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "አዘምን CloseCode በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "CloseCode ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን CloseCode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) CloseCode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "CloseCode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ CloseCode።",
  ...
  "toast.update.description": "አዲሱ የCloseCode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለCloseCode ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ CloseCode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "CloseCode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "CloseCode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የCloseCode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለCloseCode",
  ...
  "settings.general.row.appearance.description": "CloseCodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "CloseCode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "CloseCode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "CloseCode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የCloseCode እትም እያሄዱ ነው።",
  ...
  "server.row.incompatible":
    "ይህ አገልጋይ CloseCode {{version}}ን እያስኬደ ነው፣ ይህም ከዚህ መተግበሪያ ጋር ተኳሃኝ አይደለም። ለመቀጠል ወደ CloseCode V2 ያሻሽሉት።",
  ...
  "session.error.incompatible.description":
    "{{server}} CloseCode {{version}}ን እያስኬደ ነው፣ ይህም ከዚህ መተግበሪያ ጋር ተኳሃኝ አይደለም። ለመቀጠል አገልጋዩን ወደ CloseCode V2 ያሻሽሉት።",
  ...
  "settings.about.description": "CloseCode፣ ክፍት ምንጭ የኮድ ወኪል",
  "settings.about.trademark": "CloseCode የAnomaly Innovations, Inc. የተመዘገበ የንግድ ምልክት ነው።",
  ...
  "ssh.stage.checking": "የCloseCode በመፈተሽ ላይ...",
  "ssh.stage.downloading": "አገልጋይ በማውረድ ላይ...",
  "ssh.stage.uploading": "አገልጋይን በመጫን ላይ...",
  "ssh.stage.starting": "ከCloseCode ጋር በመገናኘት ላይ...",
  ...
  "ssh.error.service": "SSH ተገናኝቷል፣ ነገር ግን የCloseCode አገልጋዩ ዝግጁ አልሆነም።",
  ...
  "server.connect.scan.description": "ካሜራዎን closecode pair ወደሚያሳየው QR ኮድ ያነጣጥሩ።",
  "server.connect.scan.invalid": "ይህ የCloseCode ማጣመሪያ ኮድ አይደለም። closecode pair የሚያሳየውን ኮድ ይቃኙ።",
  ...
  "project.settings.name.description": "በመላው CloseCode ውስጥ ለዚህ ፕሮጀክት የሚታየው ስም",
  ...
  "project.settings.extensions.empty.mcps.description": "ለCloseCode የሚገኙ MCP-ዎች እዚህ ይታያሉ",
  "project.settings.extensions.empty.plugins.title": "እስካሁን ምንም ተሰኪዎች የሉም\nለCloseCode የሚገኙ",
  "project.settings.extensions.empty.plugins.description": "ለCloseCode የሚገኙ ተሰኪዎች እዚህ ይታያሉ",
  "project.settings.extensions.empty.skills.title": "እስካሁን ምንም ችሎታ የለም\nለCloseCode የሚገኙ",
  "project.settings.extensions.empty.skills.description": "ለCloseCode የሚገኙ ክህሎቶች እዚህ ይታያሉ",
  ...
  "settings.workspaces.empty.description": "በCloseCode የተፈጠሩ የሥራ ዛፎች እዚህ ይታያሉ",
  ...
  "settings.updates.action.download": "CloseCodeን አውርድ",
  "settings.updates.migration.title": "ከBeta ወደ Stable ይዛወሩ",
  "settings.updates.migration.description":
    "ለጊዜው CloseCode Beta ወደ CloseCode Stable እየተዛወረ ነው። ዝማኔዎችን መቀበልዎን ለመቀጠል ስሪት {{version}}ን ያውርዱ፣ ከዚያ CloseCodeን ከዲስክ ምስሉ ይጫኑ።",
