...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "CloseCode se nije uspio učitati",
  "Prozor aplikacije CloseCode neočekivano je zatvoren",
  "CloseCode ne reagira",
  ...
  "Instalacija aplikacije CloseCode nije uspjela",
  ...
  "CloseCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije CloseCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u CloseCode.",
  ...
  "dialog.server.description": "Promijenite na koji se CloseCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera CloseCode u {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ažuriranje CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje CloseCode u {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte CloseCode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte CloseCode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte CloseCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što CloseCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "CloseCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite CloseCode.",
  ...
  "toast.update.description": "Nova verzija CloseCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku CloseCode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, CloseCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "CloseCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite CloseCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za CloseCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako CloseCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li CloseCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je CloseCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se CloseCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju CloseCode.",
  ...
  "server.row.incompatible":
    "Ovaj poslužitelj koristi CloseCode {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite ga na CloseCode V2 kako biste nastavili.",
  ...
  "session.error.incompatible.description":
    "{{server}} koristi CloseCode {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite poslužitelj na CloseCode V2 kako biste nastavili.",
  ...
  "settings.about.trademark": "CloseCode je registrirani zaštitni znak Anomaly Innovations, Inc.",
  ...
  "ssh.error.service": "SSH je povezan, ali CloseCode poslužitelj nije postao spreman.",
  "ssh.error.host-key":
  ...
  "project.settings.name.description": "Naziv koji se prikazuje za ovaj projekt u cijelome CloseCode-u",
  ...
  "settings.updates.migration.description":
    "CloseCode Beta zasad prelazi na CloseCode Stable. Preuzmite verziju {{version}}, a zatim instalirajte CloseCode iz slike diska kako biste nastavili primati ažuriranja.",
