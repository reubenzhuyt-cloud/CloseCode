export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni CloseCode",
  ...
  "desktop.menu.ariaLabel": "Menuja CloseCode",
  ...
  "desktop.recovery.loadFailed": "CloseCode nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja CloseCode u mbyll papritur",
  "desktop.recovery.unresponsive": "CloseCode nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i CloseCode dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.opencodeMissing": "CloseCode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i CloseCode përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në CloseCode.",
  ...
  "dialog.server.description": "Ndrysho me cilin server CloseCode lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon CloseCode në {{distro}}…",
  "wsl.onboarding.updatingOpencode": "CloseCode po përditësohet…",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson CloseCode në {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Përditëso CloseCode në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni CloseCode në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se CloseCode të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "CloseCode nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap CloseCode.",
  ...
  "toast.update.description": "Një version i ri i CloseCode ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i CloseCode",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, CloseCode nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin CloseCode brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për CloseCode",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket CloseCode në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse CloseCode ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e CloseCode.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset CloseCode",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të CloseCode.",
  ...
  "desktop.cli.installed.message":
    "CLI-ja u instalua te {{path}}\n\nRinisni terminalin për të përdorur komandën 'closecode'.",
  ...
  "server.row.incompatible":
    "Ky server po ekzekuton CloseCode {{version}}, i cili nuk përputhet me këtë aplikacion. Për ta vazhduar, përmirësojeni në CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "{{server}} po ekzekuton CloseCode {{version}}, i cili nuk përputhet me këtë aplikacion. Për ta vazhduar, përmirësoni serverin në CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, agjenti kodues me burim të hapur",
  "settings.about.trademark": "CloseCode është një markë e regjistruar e Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Po kontrollon CloseCode…",
  "ssh.stage.downloading": "Serveri po shkarkohet…",
  "ssh.stage.uploading": "Serveri i ngarkimit…",
  "ssh.stage.starting": "Po lidhet me CloseCode…",
  ...
  "ssh.error.service": "SSH u lidh, por serveri CloseCode nuk u bë gati.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Drejtoje kamerën drejt kodit QR të treguar nga closecode pair.",
  "server.connect.scan.invalid": "Ky nuk është një kod çiftimi CloseCode. Skanoni kodin e treguar nga closecode pair.",
  ...
  "project.settings.name.description": "Emri i shfaqur për këtë projekt në të gjithë CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs i disponueshëm për CloseCode do të shfaqet këtu",
  "project.settings.extensions.empty.plugins.title": "Nuk ka ende shtojca",
  "project.settings.extensions.empty.plugins.description": "Shtojcat e disponueshme për CloseCode do të shfaqen këtu",
  "project.settings.extensions.empty.skills.title": "Nuk ka ende aftësi",
  "project.settings.extensions.empty.skills.description": "Aftësitë e disponueshme për CloseCode do të shfaqen këtu",
  ...
  "settings.workspaces.empty.description": "Pemët e punës të krijuara në CloseCode do të shfaqen këtu",
  ...
  "settings.updates.action.download": "Shkarko CloseCode",
  "settings.updates.migration.title": "Kalo nga Beta në versionin e qëndrueshëm",
  "settings.updates.migration.description":
    "Për momentin, CloseCode Beta po kalon te CloseCode Stable. Shkarko versionin {{version}}, pastaj instalo CloseCode nga imazhi i diskut për të vazhduar marrjen e përditësimeve.",
}
