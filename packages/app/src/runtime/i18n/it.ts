export const dict = {
  ...
  "ssh.error.service": "SSH si è connesso, ma il server CloseCode non è pronto.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Punta la fotocamera sul codice QR mostrato da closecode pair.",
  "server.connect.scan.invalid":
    "Questo non è un codice di abbinamento CloseCode. Scansiona il codice mostrato da closecode pair.",
  ...
  "project.settings.name.description": "Il nome mostrato per questo progetto in tutto CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponibile per CloseCode verrà visualizzato qui",
  "project.settings.extensions.empty.plugins.title": "Nessun plugin ancora",
  "project.settings.extensions.empty.plugins.description": "I plugin disponibili per CloseCode appariranno qui",
  "project.settings.extensions.empty.skills.title": "Nessuna competenza ancora",
  "project.settings.extensions.empty.skills.description": "Le abilità disponibili per CloseCode appariranno qui",
  ...
  "settings.workspaces.empty.description": "Gli spazi di lavoro creati in CloseCode appariranno qui",
  ...
  "settings.about.description": "CloseCode, l’agente di programmazione open source",
  "settings.about.trademark": "CloseCode è un marchio registrato di Anomaly Innovations, Inc.",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in CloseCode.",
  ...
  "dialog.server.description": "Cambia il server CloseCode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Controllo CloseCode in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aggiornamento CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento CloseCode in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna CloseCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa CloseCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che CloseCode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "CloseCode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri CloseCode.",
  ...
  "toast.update.description": "Una nuova versione di CloseCode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team CloseCode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: CloseCode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server CloseCode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per CloseCode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di CloseCode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se CloseCode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di CloseCode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di CloseCode",
  ...
  "settings.updates.toast.latest.title": "CloseCode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di CloseCode.",
  ...
  "desktop.menu.documentation": "Documentazione di CloseCode",
  ...
  "desktop.menu.ariaLabel": "Menu CloseCode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare CloseCode",
  "desktop.recovery.terminated": "La finestra di CloseCode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "CloseCode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di CloseCode non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.opencodeMissing": "CloseCode non è installato in questa distribuzione",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di CloseCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
  ...
  "desktop.cli.installed.message":
    "La CLI è stata installata in {{path}}.\n\nRiavvia il terminale per usare il comando 'closecode'.",
  ...
  "server.row.incompatible":
    "Questo server esegue CloseCode {{version}}, che non è compatibile con questa applicazione. Aggiornalo a CloseCode V2 per continuare.",
  ...
  "session.error.incompatible.description":
    "{{server}} esegue CloseCode {{version}}, che non è compatibile con questa applicazione. Aggiorna il server a CloseCode V2 per continuare.",
  ...
  "settings.updates.action.download": "Scarica CloseCode",
  "settings.updates.migration.title": "Passa da Beta a Stabile",
  "settings.updates.migration.description":
    "Per il momento, CloseCode Beta sta passando a CloseCode Stabile. Scarica la versione {{version}}, quindi installa CloseCode dall’immagine disco per continuare a ricevere gli aggiornamenti.",
}
