export const dict = {
  ...
  "ssh.stage.checking": "CloseCode controleren…",
  "ssh.stage.downloading": "Server downloaden…",
  "ssh.stage.uploading": "Server uploaden…",
  "ssh.stage.starting": "Verbinding maken met CloseCode…",
  ...
  "ssh.error.service": "SSH verbonden, maar de CloseCode-server is niet gereed geworden.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Richt uw camera op de QR-code weergegeven door closecode pair.",
  "server.connect.scan.invalid": "Dit is geen CloseCode-koppelingscode. Scan de code weergegeven door closecode pair.",
  ...
  "project.settings.name.description": "De naam die overal in CloseCode voor dit project wordt weergegeven",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs beschikbaar voor CloseCode wordt hier weergegeven",
  "project.settings.extensions.empty.plugins.title": "Nog geen plug-ins",
  "project.settings.extensions.empty.plugins.description":
    "Plug-ins die beschikbaar zijn voor CloseCode verschijnen hier",
  "project.settings.extensions.empty.skills.title": "Nog geen vaardigheden",
  "project.settings.extensions.empty.skills.description":
    "Vaardigheden die beschikbaar zijn voor CloseCode worden hier weergegeven",
  ...
  "settings.workspaces.empty.description": "Werkbomen die in CloseCode zijn gemaakt, verschijnen hier",
  ...
  "settings.about.description": "CloseCode, de open-source programmeeragent",
  "settings.about.trademark": "CloseCode is een geregistreerd handelsmerk van Anomaly Innovations, Inc.",
  ...
  "desktop.menu.documentation": "CloseCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "CloseCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het CloseCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "CloseCode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van CloseCode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.opencodeMissing": "CloseCode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De CloseCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in CloseCode te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in CloseCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in CloseCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke CloseCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode controleren…",
  "wsl.onboarding.checkingOpencodeIn": "CloseCode controleren in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "CloseCode bijwerken…",
  "wsl.onboarding.updatingOpencodeIn": "CloseCode bijwerken in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Werk CloseCode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CloseCode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "CloseCode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer CloseCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat CloseCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "CloseCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens CloseCode opnieuw.",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van CloseCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het CloseCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: CloseCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de CloseCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor CloseCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe CloseCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of CloseCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van CloseCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer CloseCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "CloseCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van CloseCode.",
  ...
  "desktop.cli.installed.message":
    "CLI is geïnstalleerd in {{path}}.\n\nStart de terminal opnieuw om de opdracht 'closecode' te gebruiken.",
  ...
  "server.row.incompatible":
    "Op deze server wordt CloseCode {{version}} uitgevoerd, dat niet compatibel is met deze app. Werk de server bij naar CloseCode V2 om door te gaan.",
  ...
  "session.error.incompatible.description":
    "Op {{server}} wordt CloseCode {{version}} uitgevoerd, dat niet compatibel is met deze app. Werk de server bij naar CloseCode V2 om door te gaan.",
  ...
  "settings.updates.action.download": "CloseCode downloaden",
  "settings.updates.migration.title": "Van Beta naar Stabiel overstappen",
  "settings.updates.migration.description":
    "CloseCode Beta gaat voorlopig over naar CloseCode Stabiel. Download versie {{version}} en installeer CloseCode daarna vanaf de schijfkopie om updates te blijven ontvangen.",
}
