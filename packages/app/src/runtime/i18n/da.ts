export const dict = {
  ...
  "ssh.stage.checking": "Tjekker CloseCode...",
  "ssh.stage.downloading": "Downloader server...",
  "ssh.stage.uploading": "Uploader server...",
  "ssh.stage.starting": "Opretter forbindelse til CloseCode...",
  ...
  "ssh.error.service": "SSH tilsluttet, men CloseCode-serveren blev ikke klar.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Ret dit kamera mod QR-koden vist af closecode pair.",
  "server.connect.scan.invalid": "Dette er ikke en CloseCode-parringskode. Scan koden vist af closecode pair.",
  ...
  "project.settings.name.description": "Navnet vist for dette projekt i hele CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tilgængelig for CloseCode vises her",
  "project.settings.extensions.empty.plugins.title": "Ingen plugins endnu",
  "project.settings.extensions.empty.plugins.description": "Plugins, der er tilgængelige for CloseCode, vises her",
  "project.settings.extensions.empty.skills.title": "Ingen færdigheder endnu",
  "project.settings.extensions.empty.skills.description": "De færdigheder, der er tilgængelige for CloseCode, vises her",
  ...
  "settings.workspaces.empty.description": "Arbejdstræer oprettet i CloseCode vises her",
  ...
  "settings.about.description": "CloseCode, open source-kodningsagenten",
  "settings.about.trademark": "CloseCode er et registreret varemærke tilhørende Anomaly Innovations, Inc.",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i CloseCode.",
  ...
  "dialog.server.description": "Skift hvilken CloseCode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker CloseCode i {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Opdaterer CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer CloseCode i {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Opdater CloseCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før CloseCode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "CloseCode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter CloseCode igen.",
  ...
  "toast.update.description": "En ny version af CloseCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CloseCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CloseCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CloseCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CloseCode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan CloseCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om CloseCode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas CloseCodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CloseCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CloseCode.",
  ...
  "desktop.recovery.loadFailed": "CloseCode kunne ikke indlæses",
  "desktop.recovery.terminated": "CloseCode-vinduet blev uventet afsluttet",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart terminalen for at bruge kommandoen 'closecode'.",
  ...
  "server.row.incompatible":
    "Denne server kører CloseCode {{version}}, som ikke er kompatibel med denne app. Opgrader den til CloseCode V2 for at fortsætte.",
  ...
  "session.error.incompatible.description":
    "{{server}} kører CloseCode {{version}}, som ikke er kompatibel med denne app. Opgrader serveren til CloseCode V2 for at fortsætte.",
  ...
  "settings.updates.action.download": "Hent CloseCode",
  "settings.updates.migration.title": "Skift fra Beta til Stabil",
  "settings.updates.migration.description":
    "CloseCode Beta flyttes indtil videre til CloseCode Stabil. Download version {{version}}, og installer derefter CloseCode fra diskaftrykket for fortsat at modtage opdateringer.",
}
