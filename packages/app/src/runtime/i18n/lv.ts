export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode dokumentācija",
  ...
  "desktop.menu.ariaLabel": "CloseCode izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt CloseCode",
  "desktop.recovery.terminated": "CloseCode logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "CloseCode neatbild",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus CloseCode.",
  ...
  "dialog.server.description": "Mainiet, pie kura CloseCode servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu CloseCode distribūcijā {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Atjauninu CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu CloseCode distribūcijā {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet CloseCode distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet CloseCode distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms CloseCode var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "CloseCode neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet CloseCode no jauna.",
  ...
  "toast.update.description": "Pieejama jauna CloseCode versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu CloseCode komandai",
  ...
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, CloseCode vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "CloseCode darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist CloseCode serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt CloseCode saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā CloseCode izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai CloseCode sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet CloseCode tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot CloseCode",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko CloseCode versiju.",
  ...
  "server.row.incompatible":
    "Šajā serverī darbojas CloseCode {{version}}, kas nav saderīga ar šo lietotni. Lai turpinātu, jauniniet serveri uz CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "Serverī {{server}} darbojas CloseCode {{version}}, kas nav saderīga ar šo lietotni. Lai turpinātu, jauniniet serveri uz CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, atvērtā koda kodēšanas aģents",
  "settings.about.trademark": "CloseCode ir Anomaly Innovations, Inc. reģistrēta preču zīme.",
  ...
  "ssh.error.service": "SSH ir izveidots savienojums, taču serveris CloseCode nebija gatavs.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Pavērsiet kameru pret QR kodu, ko parāda closecode pair.",
  "server.connect.scan.invalid": "Šis nav kods CloseCode savienošanai pārī. Skenējiet kodu, ko parāda closecode pair.",
  ...
  "project.settings.name.description": "Šī projekta nosaukums tiek rādīts visā CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, kas pieejams CloseCode, tiks parādīts šeit",
  "project.settings.extensions.empty.plugins.title": "Vēl nav spraudņu",
  "project.settings.extensions.empty.plugins.description": "CloseCode pieejamie spraudņi parādīsies šeit",
  "project.settings.extensions.empty.skills.title": "Vēl nav prasmju",
  "project.settings.extensions.empty.skills.description": "CloseCode pieejamās prasmes parādīsies šeit",
  ...
  "settings.workspaces.empty.description": "Šeit tiks parādīti CloseCode izveidotie darba koki",
  ...
  "settings.updates.action.download": "Lejupielādēt CloseCode",
  "settings.updates.migration.title": "Pāriet no Beta uz stabilo versiju",
  "settings.updates.migration.description":
    "Pagaidām CloseCode Beta tiek pārcelta uz CloseCode Stable. Lejupielādējiet versiju {{version}} un pēc tam instalējiet CloseCode no diska attēla, lai turpinātu saņemt atjauninājumus.",
}
