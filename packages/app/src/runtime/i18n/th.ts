export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด CloseCode ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง CloseCode หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "CloseCode ไม่ตอบสนอง",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย CloseCode",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CloseCode",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CloseCode",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน CloseCode",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ CloseCode ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ CloseCode ใน {{distro}}…",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต CloseCode ใน {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต CloseCode ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.opencodeReady": "CloseCode พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง CloseCode ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง CloseCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ CloseCode จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "CloseCode ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด CloseCode อีกครั้ง",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ CloseCode ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม CloseCode",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า CloseCode ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "CloseCode รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ CloseCode ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ CloseCode",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ CloseCode บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ CloseCode ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ CloseCode",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ CloseCode เปิดใช้งาน",
  ...
  "settings.updates.action.download": "ดาวน์โหลด CloseCode",
  "settings.updates.migration.title": "ย้ายจากรุ่น Beta ไปยังรุ่น Stable",
  "settings.updates.migration.description":
    "ขณะนี้ CloseCode Beta กำลังย้ายไปยัง CloseCode Stable โปรดดาวน์โหลดเวอร์ชัน {{version}} แล้วติดตั้ง CloseCode จากดิสก์อิมเมจเพื่อรับการอัปเดตต่อไป",
  "settings.updates.action.installing": "กำลังติดตั้ง…",
  "settings.updates.toast.latest.title": "คุณเป็นเวอร์ชันล่าสุดแล้ว",
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน CloseCode เวอร์ชันล่าสุด",
  ...
  "server.row.incompatible":
    "เซิร์ฟเวอร์นี้กำลังใช้งาน CloseCode {{version}} ซึ่งไม่เข้ากันกับแอปนี้ โปรดอัปเกรดเป็น CloseCode V2 เพื่อดำเนินการต่อ",
  ...
  "session.error.incompatible.description":
    "{{server}} กำลังใช้งาน CloseCode {{version}} ซึ่งไม่เข้ากันกับแอปนี้ โปรดอัปเกรดเซิร์ฟเวอร์เป็น CloseCode V2 เพื่อดำเนินการต่อ",
  ...
  "settings.about.description": "CloseCode เอเจนต์การเข้ารหัสโอเพ่นซอร์ส",
  "settings.about.trademark": "CloseCode เป็นเครื่องหมายการค้าจดทะเบียนของ Anomaly Innovations, Inc.",
  ...
  "ssh.error.service": "เชื่อมต่อ SSH แล้ว แต่เซิร์ฟเวอร์ CloseCode ยังไม่พร้อม",
  ...
  "server.connect.scan.description": "ชี้กล้องของคุณไปที่รหัส QR ที่แสดงโดยการจับคู่ CloseCode",
  "server.connect.scan.invalid": "นี่ไม่ใช่รหัสจับคู่ CloseCode สแกนรหัสที่แสดงโดย closecode pair",
  ...
  "project.settings.name.description": "ชื่อที่แสดงสำหรับโครงการนี้ทั่วทั้ง CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP ที่สามารถใช้ได้กับ CloseCode จะปรากฏที่นี่",
  "project.settings.extensions.empty.plugins.title": "ยังไม่มีปลั๊กอิน",
  "project.settings.extensions.empty.plugins.description": "ปลั๊กอินที่สามารถใช้ได้กับ CloseCode จะปรากฏที่นี่",
  "project.settings.extensions.empty.skills.title": "ยังไม่มีทักษะ",
  "project.settings.extensions.empty.skills.description": "ทักษะที่สามารถใช้ได้กับ CloseCode จะปรากฏที่นี่",
  ...
  "settings.workspaces.empty.description": "Worktree ที่สร้างใน CloseCode จะปรากฏที่นี่",
