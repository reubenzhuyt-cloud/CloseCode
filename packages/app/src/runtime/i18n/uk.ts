export const dict = {
  ...
  "desktop.menu.documentation": "Документація CloseCode",
  ...
  "desktop.menu.ariaLabel": "Меню CloseCode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити CloseCode",
  "desktop.recovery.terminated": "Роботу вікна CloseCode несподівано завершено",
  "desktop.recovery.unresponsive": "CloseCode не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити CloseCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.opencodeMissing": "CloseCode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення CloseCode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у CloseCode.",
  ...
  "dialog.server.description": "Перемкніть сервер CloseCode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка CloseCode у {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Оновлення CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення CloseCode у {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Оновіть CloseCode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть CloseCode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в CloseCode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "CloseCode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте CloseCode.",
  ...
  "toast.update.description": "Нова версія CloseCode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді CloseCode",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, CloseCode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер CloseCode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу CloseCode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд CloseCode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи CloseCode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему CloseCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску CloseCode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію CloseCode.",
  ...
  "desktop.cli.installed.message":
    "CLI інстальовано в {{path}}\n\nПерезапустіть термінал, щоб використовувати команду «closecode».",
  ...
  "server.row.incompatible":
    "На цьому сервері працює CloseCode {{version}}, несумісний із застосунком. Щоб продовжити, оновіть його до CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "На сервері {{server}} працює CloseCode {{version}}, несумісний із застосунком. Щоб продовжити, оновіть сервер до CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, агент кодування з відкритим кодом",
  "settings.about.trademark": "CloseCode є зареєстрованою торговою маркою Anomaly Innovations, Inc.",
  ...
  "ssh.error.service": "SSH підключено, але сервер CloseCode не готовий.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Наведіть камеру на QR-код, показаний closecode pair.",
  "server.connect.scan.invalid": "Це не код підключення CloseCode. Відскануйте код, показаний closecode pair.",
  ...
  "project.settings.name.description": "Назва, що відображається для цього проєкту у всьому CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP, доступні для CloseCode, з’являться тут",
  "project.settings.extensions.empty.plugins.title": "Поки немає плагінів",
  "project.settings.extensions.empty.plugins.description": "Плагіни, доступні для CloseCode, з’являться тут",
  "project.settings.extensions.empty.skills.title": "Поки немає навичок",
  "project.settings.extensions.empty.skills.description": "Навички, доступні для CloseCode, з’являться тут",
  ...
  "settings.workspaces.empty.description": "Робочі дерева, створені в CloseCode, з’являться тут",
  ...
  "settings.updates.action.download": "Завантажити CloseCode",
  "settings.updates.migration.title": "Перейти з Beta на Stable",
  "settings.updates.migration.description":
    "Наразі CloseCode Beta переходить на CloseCode Stable. Завантажте версію {{version}}, а потім установіть CloseCode з образу диска, щоб і надалі отримувати оновлення.",
