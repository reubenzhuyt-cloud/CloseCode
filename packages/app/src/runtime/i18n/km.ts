export const dict = {
  ...
  "desktop.menu.documentation": "ឯកសារ CloseCode",
  ...
  "desktop.menu.ariaLabel": "ម៉ឺនុយ CloseCode",
  ...
  "desktop.recovery.loadFailed": "CloseCode បានបរាជ័យក្នុងការផ្ទុក",
  "desktop.recovery.terminated": "បង្អួច CloseCode ត្រូវបានបញ្ចប់ដោយមិននឹកស្មានដល់",
  "desktop.recovery.unresponsive": "CloseCode មិនឆ្លើយតបទេ។",
  ...
  "dialog.model.unpaid.freeModels.title": "ម៉ូដែលឥតគិតថ្លៃដែលផ្តល់ដោយ CloseCode",
  ...
  "provider.connect.apiKey.description":
    "បញ្ចូល {{provider}} API key របស់អ្នក ដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង CloseCode។",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ផ្តល់ឱ្យអ្នកនូវម៉ូដែលដែលបានជ្រើសរើស និងកែលម្អសម្រាប់ភ្នាក់ងារសរសេរកូដ។",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "ដើម្បីប្រមូលលេខកូដអនុញ្ញាតរបស់អ្នកដើម្បីភ្ជាប់គណនីរបស់អ្នក និងប្រើម៉ូដែល {{provider}} នៅក្នុង CloseCode ។",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ហើយបញ្ចូលលេខកូដខាងក្រោមដើម្បីភ្ជាប់គណនីរបស់អ្នក ហើយប្រើម៉ូដែល {{provider}} នៅក្នុង CloseCode។",
  ...
  "dialog.server.description": "ប្តូរម៉ាស៊ីនមេ CloseCode ដែលកម្មវិធីនេះភ្ជាប់ទៅ។",
  ...
  "wsl.onboarding.checkingOpencode": "កំពុងពិនិត្យមើលកូដ CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "កំពុងពិនិត្យកូដ CloseCode ក្នុង {{distro}}…",
  "wsl.onboarding.updatingOpencode": "កំពុងអាប់ដេត CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "កំពុងអាប់ដេត CloseCode ក្នុង {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "ធ្វើបច្ចុប្បន្នភាព CloseCode ក្នុង {{distro}} ។",
  "wsl.onboarding.updateOpencode": "ធ្វើបច្ចុប្បន្នភាព CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode គឺរួចរាល់នៅក្នុង {{distro}} ។",
  "wsl.onboarding.opencodeReady": "CloseCode គឺរួចរាល់។",
  "wsl.onboarding.installOpencodeIn": "ដំឡើង CloseCode ក្នុង {{distro}} ។",
  "wsl.onboarding.installOpencode": "ដំឡើង CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode មិនត្រូវបានដំឡើងទេ។",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ប្រព័ន្ធរងវីនដូសម្រាប់លីនុច) ត្រូវបានទាមទារ មុនពេល CloseCode អាចបន្ថែមម៉ាស៊ីនមេ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL មិនអាចប្រើបានទេ។",
  "wsl.onboarding.wslUnavailable.description": "CloseCode មិនអាចផ្ទៀងផ្ទាត់ WSL នៅលើម៉ាស៊ីននេះបានទេ។",
  "wsl.onboarding.installWsl": "ដំឡើង WSL",
  "wsl.onboarding.windowsRestartRequired":
    "ចាប់ផ្ដើម Windows ឡើងវិញ ដើម្បីបញ្ចប់ការដំឡើង WSL បន្ទាប់មកបើក CloseCode ឡើងវិញ។",
  ...
  "toast.update.description": "កំណែថ្មីនៃ CloseCode ({{version}}) ឥឡូវនេះមានសម្រាប់ដំឡើងហើយ។",
  ...
  "error.page.report.prefix": "សូមរាយការណ៍ពីកំហុសនេះទៅកាន់ក្រុម CloseCode",
  ...
  "error.chain.mcpFailed": 'ម៉ាស៊ីនមេ MCP "{{name}}" បានបរាជ័យ។ ចំណាំ CloseCode មិនគាំទ្រការផ្ទៀងផ្ទាត់ MCP នៅឡើយទេ។',
  ...
  "sidebar.gettingStarted.line1": "CloseCode រួមបញ្ចូលម៉ូដែលឥតគិតថ្លៃ ដូច្នេះអ្នកអាចចាប់ផ្តើមភ្លាមៗ។",
  ...
  "settings.desktop.wsl.description": "ដំណើរការម៉ាស៊ីនមេ CloseCode នៅខាងក្នុង WSL នៅលើ Windows ។",
  ...
  "settings.general.row.language.description": "ប្តូរភាសាបង្ហាញសម្រាប់ CloseCode",
  ...
  "settings.general.row.appearance.description": "ប្ដូរតាមបំណងពីរបៀបដែល CloseCode មើលទៅលើឧបករណ៍របស់អ្នក។",
  "settings.general.row.colorScheme.title": "ពណ៌ចម្រុះ",
  "settings.general.row.colorScheme.description": "ជ្រើសរើសថាតើ CloseCode ធ្វើតាមប្រព័ន្ធ ពន្លឺ ឬរូបរាងងងឹត",
  "settings.general.row.theme.title": "ស្បែក",
  "settings.general.row.theme.description": "ប្ដូរតាមបំណងពីរបៀបដែល CloseCode មានប្រធានបទ។",
  ...
  "settings.updates.row.startup.description": "ពិនិត្យមើលការអាប់ដេតដោយស្វ័យប្រវត្តិនៅពេលដែល CloseCode ចាប់ផ្តើម",
  ...
  "settings.updates.action.download": "ទាញយក CloseCode",
  "settings.updates.migration.title": "ផ្លាស់ប្តូរពី Beta ទៅ Stable",
  "settings.updates.migration.description":
    "សម្រាប់ពេលនេះ CloseCode Beta កំពុងផ្លាស់ប្តូរទៅ CloseCode Stable។ ទាញយកកំណែ {{version}} បន្ទាប់មកដំឡើង CloseCode ពីរូបភាពថាស ដើម្បីបន្តទទួលបានបច្ចុប្បន្នភាព។",
  "settings.updates.action.installing": "កំពុងដំឡើង…",
  "settings.updates.toast.latest.title": "អ្នកទាន់សម័យហើយ។",
  "settings.updates.toast.latest.description": "អ្នកកំពុងដំណើរការកំណែចុងក្រោយបំផុតនៃ CloseCode ។",
  ...
  "desktop.cli.installed.message":
    "បានដំឡើង CLI ទៅ {{path}}\n\nចាប់ផ្ដើមស្ថានីយរបស់អ្នកឡើងវិញ ដើម្បីប្រើពាក្យបញ្ជា 'closecode'។",
  ...
  "server.row.incompatible":
    "ម៉ាស៊ីនមេនេះកំពុងដំណើរការ CloseCode {{version}} ដែលមិនត្រូវគ្នាជាមួយកម្មវិធីនេះទេ។ ដំឡើងកំណែទៅ CloseCode V2 ដើម្បីបន្ត។",
  ...
  "session.error.incompatible.description":
    "{{server}} កំពុងដំណើរការ CloseCode {{version}} ដែលមិនត្រូវគ្នាជាមួយកម្មវិធីនេះទេ។ ដំឡើងកំណែម៉ាស៊ីនមេទៅ CloseCode V2 ដើម្បីបន្ត។",
  ...
  "settings.about.description": "CloseCode ដែលជាភ្នាក់ងារសរសេរកូដប្រភពបើកចំហ",
  "settings.about.trademark": "CloseCode គឺជាពាណិជ្ជសញ្ញាដែលបានចុះបញ្ជីរបស់ Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "កំពុងពិនិត្យ CloseCode…",
  "ssh.stage.downloading": "កំពុងទាញយកម៉ាស៊ីនមេ…",
  "ssh.stage.uploading": "កំពុងផ្ទុកម៉ាស៊ីនមេឡើង…",
  "ssh.stage.starting": "កំពុងតភ្ជាប់ទៅ CloseCode…",
  ...
  "ssh.error.service": "SSH បានភ្ជាប់, ប៉ុន្តែម៉ាស៊ីនបម្រើ CloseCode មិនបានត្រៀមខ្លួនទេ។",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "បង្ខំកាមេរ៉ារបស់អ្នកទៅកូដ QR ដែលបង្ហាញដោយ closecode pair។",
  "server.connect.scan.invalid": "នេះមិនមែនជាកូដផ្គុំ CloseCode ទេ។ ស្កេនកូដដែលបង្ហាញដោយ closecode pair។",
  ...
  "project.settings.name.description": "ឈ្មោះដែលបង្ហាញសម្រាប់គម្រោងនេះទូទាំង CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs ដែលអាចប្រើសម្រាប់ CloseCode នឹងបង្ហាញនៅទីនេះ",
  "project.settings.extensions.empty.plugins.title": "មិនមានផ្លាស៊ីនទេ",
  "project.settings.extensions.empty.plugins.description": "ផ្លាស៊ីនដែលអាចប្រើសម្រាប់ CloseCode នឹងបង្ហាញនៅទីនេះ",
  "project.settings.extensions.empty.skills.title": "មិនមានជំនាញទេ",
  "project.settings.extensions.empty.skills.description": "ជំនាញដែលអាចប្រើសម្រាប់ CloseCode នឹងបង្ហាញនៅទីនេះ",
  ...
  "settings.workspaces.empty.description": "Worktrees ដែលបានបង្កើតក្នុង CloseCode នឹងបង្ហាញនៅទីនេះ",
