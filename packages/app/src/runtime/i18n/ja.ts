export const dict = {
  ...
  "desktop.recovery.loadFailed": "CloseCodeを読み込めませんでした",
  "desktop.recovery.terminated": "CloseCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "CloseCodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "CloseCodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはCloseCodeがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "CloseCodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはCloseCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "CloseCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、CloseCodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCloseCodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、CloseCodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するCloseCodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCodeを確認中…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCloseCodeを確認中…",
  "wsl.onboarding.updatingOpencode": "CloseCodeを更新中…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCloseCodeを更新中…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCloseCodeを更新してください。",
  "wsl.onboarding.updateOpencode": "CloseCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCloseCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "CloseCodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCloseCodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "CloseCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CloseCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、CloseCodeをもう一度開いてください。",
  ...
  "toast.update.description": "CloseCodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCloseCodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CloseCodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "CloseCodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCloseCodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "CloseCodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCloseCodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "CloseCodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "CloseCodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "CloseCode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.action.download": "CloseCodeをダウンロード",
  "settings.updates.migration.title": "ベータ版から安定版へ移行",
  "settings.updates.migration.description":
    "現在、CloseCode BetaはCloseCode安定版へ移行中です。更新を引き続き受け取るには、バージョン{{version}}をダウンロードし、ディスクイメージからCloseCodeをインストールしてください。",
  "settings.updates.action.installing": "インストール中…",
  "settings.updates.toast.latest.title": "最新です",
  "settings.updates.toast.latest.description": "CloseCode は最新バージョンです。",
  ...
  "server.row.incompatible":
    "このサーバーでは、このアプリと互換性のない CloseCode {{version}} が実行されています。続行するには CloseCode V2 にアップグレードしてください。",
  ...
  "session.error.incompatible.description":
    "{{server}} では、このアプリと互換性のない CloseCode {{version}} が実行されています。続行するには、サーバーを CloseCode V2 にアップグレードしてください。",
  ...
  "settings.about.description": "オープンソースのコーディングエージェントであるCloseCode",
  "settings.about.trademark": "CloseCodeはAnomaly Innovations, Inc.の登録商標です。",
  ...
  "ssh.stage.checking": "CloseCodeをチェック中…",
  "ssh.stage.downloading": "サーバーをダウンロード中…",
  "ssh.stage.uploading": "サーバーをアップロード中…",
  "ssh.stage.starting": "CloseCodeに接続中…",
  ...
  "ssh.error.service": "SSH は接続されましたが、CloseCode サーバーが準備できませんでした。",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "closecode pair に表示されたQRコードにカメラを向けてください。",
  "server.connect.scan.invalid":
    "これはCloseCodeのペアリングコードではありません。closecode pair に表示されたコードをスキャンしてください。",
  ...
  "project.settings.name.description": "CloseCode全体でこのプロジェクトに表示される名前",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCodeで利用可能なMCPはここに表示されます",
  "project.settings.extensions.empty.plugins.title": "まだプラグインはありません",
  "project.settings.extensions.empty.plugins.description": "CloseCodeで利用可能なプラグインはここに表示されます",
  "project.settings.extensions.empty.skills.title": "まだスキルはありません",
  "project.settings.extensions.empty.skills.description": "CloseCodeで利用可能なスキルはここに表示されます",
  ...
  "settings.workspaces.empty.description": "CloseCodeで作成されたワークツリーはここに表示されます",
