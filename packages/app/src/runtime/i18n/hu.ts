...
const desktop = [
  ...
  "Kilépés",
  "Az CloseCode betöltése sikertelen",
  "Az CloseCode ablaka váratlanul leállt",
  "Az CloseCode nem válaszol",
  ...
  "Az CloseCode telepítése sikertelen",
  ...
  "Az CloseCode nincs telepítve ebben: {{distro}}",
  "Az CloseCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "A CloseCode ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a CloseCode-ben.",
  ...
  "provider.connect.opencodeZen.line1":
    "A CloseCode Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a CloseCode-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a CloseCode-ben.",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik CloseCode szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode ellenőrzése…",
  "wsl.onboarding.checkingOpencodeIn": "CloseCode ellenőrzése a {{distro}}-ben…",
  "wsl.onboarding.updatingOpencode": "CloseCode frissítése…",
  "wsl.onboarding.updatingOpencodeIn": "CloseCode frissítése a {{distro}}-ben…",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a CloseCode-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a CloseCode-t",
  "wsl.onboarding.opencodeReadyIn": "A CloseCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "A CloseCode készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a CloseCode-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a CloseCode-t",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A CloseCode nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a CloseCode hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A CloseCode nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a CloseCode programot.",
  ...
  "toast.update.description": "A CloseCode ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a CloseCode csapatának",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a CloseCode még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A CloseCode ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "CloseCode asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a CloseCode szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a CloseCode kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a CloseCode az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a CloseCode a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a CloseCode témáját.",
  ...
  "settings.updates.row.startup.description": "A CloseCode indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a CloseCode legújabb verzióját futtatja.",
  ...
  "server.row.incompatible":
    "Ez a kiszolgáló az CloseCode {{version}} verzióját futtatja, amely nem kompatibilis ezzel az alkalmazással. A folytatáshoz frissítse CloseCode V2-re.",
  ...
  "session.error.incompatible.description":
    "A(z) {{server}} az CloseCode {{version}} verzióját futtatja, amely nem kompatibilis ezzel az alkalmazással. A folytatáshoz frissítse a kiszolgálót CloseCode V2-re.",
  ...
  "settings.about.description": "CloseCode, a nyílt forráskódú kódoló ügynök",
  "settings.about.trademark": "A CloseCode a Anomaly Innovations, Inc. bejegyzett védjegye.",
  ...
  "ssh.stage.checking": "CloseCode ellenőrzése…",
  "ssh.stage.downloading": "Szerver letöltése…",
  "ssh.stage.uploading": "Szerver feltöltése…",
  "ssh.stage.starting": "Csatlakozás a CloseCode-hez…",
  ...
  "ssh.error.service": "A SSH csatlakozott, de a CloseCode szerver nem vált készenlétben.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Irányítsa kameráját a closecode pair által mutatott QR kódra.",
  "server.connect.scan.invalid": "Ez nem egy CloseCode párosítási kód. Olvassa be a closecode pair által mutatott kódot.",
  ...
  "project.settings.name.description": "A projekt neve a CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "A CloseCode számára elérhető MCPs itt jelenik meg",
  ...
  "project.settings.extensions.empty.plugins.description":
    "A CloseCode számára elérhető beépülő modulok itt jelennek meg",
  "project.settings.extensions.empty.skills.title": "Még nincsenek készségek",
  "project.settings.extensions.empty.skills.description": "A CloseCode számára elérhető készségek itt jelennek meg",
  ...
  "settings.workspaces.empty.description": "A CloseCode-ben létrehozott munkafák itt jelennek meg",
  ...
  "settings.updates.action.download": "CloseCode letöltése",
  "settings.updates.migration.title": "Váltás a Bétáról a Stabil verzióra",
  "settings.updates.migration.description":
    "Az CloseCode Beta egyelőre átkerül az CloseCode Stable verzióba. Töltse le a(z) {{version}} verziót, majd telepítse az CloseCode-ot a lemezképből a frissítések további fogadásához.",
}
