...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "CloseCode įkelti nepavyko",
  "CloseCode langas netikėtai užsidarė",
  "CloseCode neatsako",
  ...
  "CloseCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "CloseCode neįdiegtas distributyve {{distro}}",
  "CloseCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami CloseCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius CloseCode.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio CloseCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama CloseCode {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas CloseCode {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite CloseCode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite CloseCode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad CloseCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "CloseCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite CloseCode.",
  ...
  "toast.update.description": "Dabar galima įdiegti naują CloseCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą CloseCode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad CloseCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "CloseCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "CloseCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite CloseCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite CloseCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip CloseCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar CloseCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite CloseCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas CloseCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią CloseCode versiją.",
  ...
  "server.row.incompatible":
    "Šiame serveryje veikia CloseCode {{version}}, nesuderinama su šia programa. Norėdami tęsti, atnaujinkite serverį į CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "Serveryje {{server}} veikia CloseCode {{version}}, nesuderinama su šia programa. Norėdami tęsti, atnaujinkite serverį į CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, atvirojo kodo kodavimo agentas",
  "settings.about.trademark": "CloseCode yra registruotasis Anomaly Innovations, Inc. prekės ženklas.",
  ...
  "ssh.error.service": "SSH prisijungė, bet CloseCode serveris nepasiruošė.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Nukreipkite fotoaparatą į QR kodą, rodomą closecode pair.",
  "server.connect.scan.invalid": "Tai nėra CloseCode susiejimo kodas. Nuskaitykite kodą, kurį rodo closecode pair.",
  ...
  "project.settings.name.description": "Šio projekto pavadinimas rodomas visame CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, pasiekiamas CloseCode, bus rodomas čia",
  "project.settings.extensions.empty.plugins.title": "Papildinių dar nėra",
  "project.settings.extensions.empty.plugins.description": "Čia bus rodomi CloseCode prieinami papildiniai",
  "project.settings.extensions.empty.skills.title": "Dar nėra įgūdžių",
  "project.settings.extensions.empty.skills.description": "Čia bus rodomi CloseCode įgūdžiai",
  ...
  "settings.workspaces.empty.description": "Čia bus rodomi CloseCode sukurti darbo medžiai",
  ...
  "settings.updates.action.download": "Atsisiųsti „CloseCode“",
  "settings.updates.migration.title": "Pereiti iš beta į stabilią versiją",
  "settings.updates.migration.description":
    "Kol kas „CloseCode Beta“ perkeliama į „CloseCode Stable“. Atsisiųskite {{version}} versiją, tada įdiekite „CloseCode“ iš disko atvaizdžio, kad ir toliau gautumėte naujinimus.",
}
