export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Документација",
  ...
  "desktop.menu.ariaLabel": "CloseCode мени",
  ...
  "desktop.recovery.loadFailed": "CloseCode не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот CloseCode неочекувано заврши",
  "desktop.recovery.unresponsive": "CloseCode не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата CloseCode не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.opencodeMissing": "CloseCode не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode е инсталиран, но не може да се изврши",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во CloseCode.",
  ...
  "dialog.server.description": "Променете на кој CloseCode сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува CloseCode во {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Се ажурира CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира CloseCode во {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте CloseCode во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode е подготвен во {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте CloseCode во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред CloseCode да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "CloseCode не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете CloseCode.",
  ...
  "toast.update.description": "Новата верзија на CloseCode ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот CloseCode",
  ...
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, CloseCode сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "CloseCode вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот CloseCode во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за CloseCode",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа CloseCode на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали CloseCode ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како CloseCode е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува CloseCode",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на CloseCode.",
  ...
  "desktop.cli.installed.message":
    "CLI е инсталиран во {{path}}\n\nРестартирајте го терминалот за да ја користите наредбата 'closecode'.",
  ...
  "server.row.incompatible":
    "Овој сервер користи CloseCode {{version}}, кој не е компатибилен со апликацијава. Надградете го на CloseCode V2 за да продолжите.",
  ...
  "session.error.incompatible.description":
    "{{server}} користи CloseCode {{version}}, кој не е компатибилен со апликацијава. Надградете го серверот на CloseCode V2 за да продолжите.",
  ...
  "settings.about.description": "CloseCode, агент за кодирање со отворен код",
  "settings.about.trademark": "CloseCode е регистрирана трговска марка на Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Проверка на CloseCode…",
  "ssh.stage.downloading": "Преземање на сервер…",
  "ssh.stage.uploading": "Серверот се поставува…",
  "ssh.stage.starting": "Се поврзува со CloseCode…",
  ...
  "ssh.error.service": "SSH е поврзан, но серверот CloseCode не стана подготвен.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Насочете ја вашата камера кон QR кодот прикажан од closecode pair.",
  "server.connect.scan.invalid": "Ова не е CloseCode паринг код. Скенирајте го кодот прикажан од closecode pair.",
  ...
  "project.settings.name.description": "Името што се прикажува за овој проект низ CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs достапни за CloseCode ќе се појават тука",
  "project.settings.extensions.empty.plugins.title": "Сè уште нема приклучоци",
  "project.settings.extensions.empty.plugins.description": "Приклучоци достапни за CloseCode ќе се појават тука",
  "project.settings.extensions.empty.skills.title": "Сè уште нема вештини",
  "project.settings.extensions.empty.skills.description": "Вештини достапни за CloseCode ќе се појават тука",
  ...
  "settings.workspaces.empty.description": "Worktrees креирани во CloseCode ќе се прикажат тука",
  ...
  "settings.updates.action.download": "Преземи CloseCode",
  "settings.updates.migration.title": "Премини од Beta на Stable",
  "settings.updates.migration.description":
    "Засега CloseCode Beta преминува на CloseCode Stable. Преземете ја верзијата {{version}}, а потоа инсталирајте го CloseCode од сликата на дискот за да продолжите да добивате ажурирања.",
