export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za CloseCode",
  ...
  "desktop.recovery.loadFailed": "CloseCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor CloseCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "CloseCode ne reaguje",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CloseCode-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CloseCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CloseCode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se CloseCode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Provjera CloseCode u distribuciji {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ažuriranje CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje CloseCode u distribuciji {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj CloseCode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj CloseCode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi CloseCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "CloseCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori CloseCode.",
  ...
  "toast.update.description": "Nova verzija CloseCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CloseCode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CloseCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CloseCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CloseCode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako CloseCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CloseCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CloseCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CloseCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CloseCode-a.",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nPonovo pokrenite terminal da biste koristili naredbu 'closecode'.",
  ...
  "server.row.incompatible":
    "Ovaj server koristi CloseCode {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite ga na CloseCode V2 da biste nastavili.",
  ...
  "session.error.incompatible.description":
    "{{server}} koristi CloseCode {{version}}, koji nije kompatibilan s ovom aplikacijom. Nadogradite server na CloseCode V2 da biste nastavili.",
  ...
  "settings.about.description": "CloseCode, agent za kodiranje otvorenog koda",
  "settings.about.trademark": "CloseCode je registrovani zaštitni znak Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Provjera CloseCode-a…",
  "ssh.stage.downloading": "Preuzimanje servera…",
  "ssh.stage.uploading": "Slanje servera…",
  "ssh.stage.starting": "Povezivanje s CloseCode-om…",
  ...
  "ssh.error.service": "SSH je povezan, ali CloseCode server nije postao spreman.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Usmjerite kameru prema QR kodu koji prikazuje closecode pair.",
  "server.connect.scan.invalid": "Ovo nije CloseCode kod za uparivanje. Skenirajte kod koji prikazuje closecode pair.",
  ...
  "project.settings.name.description": "Naziv koji se prikazuje za ovaj projekat u cijelom CloseCode-u",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP-ovi dostupni CloseCode-u pojavit će se ovdje",
  "project.settings.extensions.empty.plugins.title": "Još nema dodataka",
  "project.settings.extensions.empty.plugins.description": "Dodaci dostupni CloseCode-u pojavit će se ovdje",
  "project.settings.extensions.empty.skills.title": "Još nema vještina",
  "project.settings.extensions.empty.skills.description": "Vještine dostupne CloseCode-u pojavit će se ovdje",
  ...
  "settings.workspaces.empty.description": "Worktreeovi kreirani u CloseCode-u pojavit će se ovdje",
  ...
  "settings.updates.action.download": "Preuzmi CloseCode",
  "settings.updates.migration.title": "Prelazak sa Beta na Stable",
  "settings.updates.migration.description":
    "CloseCode Beta za sada prelazi na CloseCode Stable. Preuzmite verziju {{version}}, a zatim instalirajte CloseCode iz slike diska da biste nastavili primati ažuriranja.",
