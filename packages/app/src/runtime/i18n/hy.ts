export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "CloseCode մենյու",
  ...
  "desktop.recovery.loadFailed": "CloseCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "CloseCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "CloseCode-ը չի արձագանքում",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և CloseCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և CloseCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և CloseCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ CloseCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է CloseCode-ը {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է CloseCode-ը {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել CloseCode-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "CloseCode պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք CloseCode-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի CloseCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "CloseCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք CloseCode։",
  ...
  "toast.update.description": "CloseCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին CloseCode թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ CloseCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "CloseCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք CloseCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն CloseCode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է CloseCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ CloseCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է CloseCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ CloseCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք CloseCode-ի վերջին տարբերակը։",
  ...
  "server.row.incompatible":
    "Այս սերվերում աշխատում է CloseCode {{version}}-ը, որն անհամատեղելի է այս հավելվածի հետ։ Շարունակելու համար թարմացրեք այն CloseCode V2-ի։",
  ...
  "session.error.incompatible.description":
    "{{server}}-ում աշխատում է CloseCode {{version}}-ը, որն անհամատեղելի է այս հավելվածի հետ։ Շարունակելու համար սերվերը թարմացրեք CloseCode V2-ի։",
  ...
  "settings.about.description": "CloseCode՝ բաց կոդով կոդավորման գործակալ",
  "settings.about.trademark": "CloseCode-ը Anomaly Innovations, Inc.-ի գրանցված ապրանքային նշանն է։",
  ...
  "ssh.stage.checking": "Ստուգում CloseCode-ը…",
  "ssh.stage.downloading": "Ներբեռնում սերվերը…",
  "ssh.stage.uploading": "Վերբեռնում սերվերը…",
  "ssh.stage.starting": "Կապ հաստատվում է CloseCode-ին…",
  ...
  "ssh.error.service": "SSH կապը հաստատված է, բայց CloseCode սերվերը չի պատրաստվել:",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Տեսախցիկն ուղղեք closecode pair-ի ցուցադրած QR կոդին։",
  "server.connect.scan.invalid": "Սա CloseCode-ի զուգակցման կոդ չէ։ Սկանավորեք closecode pair-ի ցուցադրած կոդը։",
  ...
  "project.settings.name.description": "Այս անունը կցուցադրվի նախագծի համար ամբողջ CloseCode-ում",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode-ում հասանելի MCP-ները կցուցադրվեն այստեղ",
  "project.settings.extensions.empty.plugins.title": "Ավելացումներ դեռ չկան",
  "project.settings.extensions.empty.plugins.description": "CloseCode-ի համար հասանելի ավելացումները կհայտնվեն այստեղ",
  "project.settings.extensions.empty.skills.title": "Կառավարվում հաստատված հմտություններ չունի",
  "project.settings.extensions.empty.skills.description": "CloseCode-ի համար հասանելի կարողությունները կհայտնվեն այստեղ",
  ...
  "settings.workspaces.empty.description": "CloseCode-ում ստեղծված աշխատանքային ծառերը կհայտնվեն այստեղ",
  ...
  "settings.updates.action.download": "Ներբեռնել CloseCode-ը",
  "settings.updates.migration.title": "Beta-ից անցնել Stable-ի",
  "settings.updates.migration.description":
    "Առայժմ CloseCode Beta-ն անցնում է CloseCode Stable-ի։ Ներբեռնեք {{version}} տարբերակը, ապա տեղադրեք CloseCode-ը սկավառակի պատկերից՝ թարմացումները շարունակելու համար։",
