export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu CloseCode",
  ...
  "desktop.recovery.loadFailed": "Không tải được CloseCode",
  "desktop.recovery.terminated": "Cửa sổ CloseCode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "CloseCode không phản hồi",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do CloseCode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong CloseCode.",
  ...
  "dialog.server.description": "Chuyển máy chủ CloseCode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra CloseCode trong {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật CloseCode trong {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật CloseCode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt CloseCode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi CloseCode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "CloseCode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại CloseCode.",
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của CloseCode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm CloseCode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: CloseCode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ CloseCode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho CloseCode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của CloseCode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem CloseCode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của CloseCode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi CloseCode khởi chạy",
  ...
  "settings.updates.action.download": "Tải CloseCode xuống",
  "settings.updates.migration.title": "Chuyển từ Beta sang bản ổn định",
  "settings.updates.migration.description":
    "Hiện tại, CloseCode Beta đang chuyển sang CloseCode ổn định. Hãy tải phiên bản {{version}} xuống, sau đó cài đặt CloseCode từ ảnh đĩa để tiếp tục nhận bản cập nhật.",
  "settings.updates.action.installing": "Đang cài đặt…",
  "settings.updates.toast.latest.title": "Đã cập nhật",
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của CloseCode.",
  ...
  "server.row.incompatible":
    "Máy chủ này đang chạy CloseCode {{version}}, không tương thích với ứng dụng này. Hãy nâng cấp lên CloseCode V2 để tiếp tục.",
  ...
  "session.error.incompatible.description":
    "{{server}} đang chạy CloseCode {{version}}, không tương thích với ứng dụng này. Hãy nâng cấp máy chủ lên CloseCode V2 để tiếp tục.",
  ...
  "settings.about.description": "CloseCode, tác nhân mã hóa nguồn mở",
  "settings.about.trademark": "CloseCode là nhãn hiệu đã đăng ký của Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Đang kiểm tra CloseCode…",
  "ssh.stage.downloading": "Đang tải máy chủ xuống…",
  "ssh.stage.uploading": "Đang tải máy chủ lên…",
  "ssh.stage.starting": "Đang kết nối với CloseCode…",
  ...
  "ssh.error.service": "Đã kết nối SSH, nhưng máy chủ CloseCode chưa sẵn sàng.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Đây không phải mã ghép cặp CloseCode. Quét mã được hiển thị bởi ghép cặp opencode.",
  ...
  "project.settings.name.description": "Tên hiển thị cho dự án này trên toàn CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "Các MCP có sẵn cho CloseCode sẽ xuất hiện ở đây",
  "project.settings.extensions.empty.plugins.title": "Chưa có plugin nào",
  "project.settings.extensions.empty.plugins.description": "Các plugin có sẵn cho CloseCode sẽ xuất hiện ở đây",
  "project.settings.extensions.empty.skills.title": "Chưa có kỹ năng nào",
  "project.settings.extensions.empty.skills.description": "Các kỹ năng có sẵn cho CloseCode sẽ xuất hiện ở đây",
  ...
  "settings.workspaces.empty.description": "Các worktree được tạo trong CloseCode sẽ xuất hiện ở đây",
