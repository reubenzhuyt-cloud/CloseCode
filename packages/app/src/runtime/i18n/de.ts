...
export const dict = {
  ...
  "ssh.stage.checking": "Überprüfung CloseCode…",
  "ssh.stage.downloading": "Server wird heruntergeladen…",
  "ssh.stage.uploading": "Server wird hochgeladen…",
  "ssh.stage.starting": "Verbindung mit CloseCode herstellen…",
  ...
  "ssh.error.service": "SSH ist verbunden, aber der CloseCode-Server ist nicht bereit.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Richten Sie Ihre Kamera auf den von closecode pair angezeigten Code QR.",
  "server.connect.scan.invalid":
    "Dies ist kein CloseCode-Pairing-Code. Scannen Sie den von closecode pair angezeigten Code.",
  ...
  "project.settings.name.description": "Der für dieses Projekt durchgehend angezeigte Name CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs verfügbar für CloseCode wird hier angezeigt",
  "project.settings.extensions.empty.plugins.title": "Noch keine Plugins",
  "project.settings.extensions.empty.plugins.description": "Für CloseCode verfügbare Plugins werden hier angezeigt",
  ...
  "project.settings.extensions.empty.skills.description":
    "Hier werden die für CloseCode verfügbaren Fähigkeiten angezeigt",
  ...
  "settings.workspaces.empty.description": "In CloseCode erstellte Arbeitsbereiche werden hier angezeigt",
  ...
  "settings.about.description": "CloseCode, der Open-Source-Coding-Agent",
  "settings.about.trademark": "CloseCode ist eine eingetragene Marke von Anomaly Innovations, Inc.",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CloseCode zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in CloseCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CloseCode zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den CloseCode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "CloseCode",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "CloseCode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "CloseCode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "CloseCode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie CloseCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CloseCode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "CloseCode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "CloseCode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie CloseCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "CloseCode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor CloseCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "CloseCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann CloseCode erneut.",
  ...
  "toast.update.description": "Eine neue Version von CloseCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CloseCode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CloseCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "CloseCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "CloseCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "CloseCode Desktop",
  ...
  "settings.desktop.wsl.description": "CloseCode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CloseCode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie CloseCode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob CloseCode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CloseCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CloseCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "CloseCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von CloseCode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "CloseCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das CloseCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "CloseCode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.opencodeMissing": "CloseCode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das CloseCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "desktop.cli.installed.message":
    "CLI wurde unter {{path}} installiert.\n\nStarten Sie Ihr Terminal neu, um den Befehl 'closecode' zu verwenden.",
  ...
  "server.row.incompatible":
    "Auf diesem Server wird CloseCode {{version}} ausgeführt, das mit dieser App nicht kompatibel ist. Aktualisieren Sie ihn auf CloseCode V2, um fortzufahren.",
  ...
  "session.error.incompatible.description":
    "Auf {{server}} wird CloseCode {{version}} ausgeführt, das mit dieser App nicht kompatibel ist. Aktualisieren Sie den Server auf CloseCode V2, um fortzufahren.",
  ...
  "settings.updates.action.download": "CloseCode herunterladen",
  "settings.updates.migration.title": "Von Beta zu Stabil wechseln",
  "settings.updates.migration.description":
    "CloseCode Beta wird vorerst zu CloseCode Stabil verschoben. Laden Sie Version {{version}} herunter und installieren Sie CloseCode anschließend über das Disk-Image, um weiterhin Updates zu erhalten.",
