...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CloseCode 加载失败",
  "desktop.recovery.terminated": "CloseCode 窗口意外终止",
  "desktop.recovery.unresponsive": "CloseCode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.opencodeMissing": "此发行版中未安装 CloseCode",
  "desktop.wsl.error.opencodeCannotRun": "已安装 CloseCode，但无法运行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 CloseCode",
  "desktop.wsl.error.updateVersion":
    "CloseCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 CloseCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "CloseCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 CloseCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 CloseCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 CloseCode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 CloseCode…",
  "wsl.onboarding.updatingOpencode": "正在更新 CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 CloseCode…",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 CloseCode。",
  "wsl.onboarding.updateOpencode": "更新 CloseCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 CloseCode 已就绪。",
  "wsl.onboarding.opencodeReady": "CloseCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 CloseCode。",
  "wsl.onboarding.installOpencode": "安装 CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 CloseCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "CloseCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "CloseCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 CloseCode。",
  ...
  "toast.update.description": "CloseCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 CloseCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：CloseCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "CloseCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 CloseCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 CloseCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 CloseCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 CloseCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 CloseCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 CloseCode 启动时自动检查更新",
  ...
  "settings.updates.action.download": "下载 CloseCode",
  "settings.updates.migration.title": "从 Beta 版迁移到稳定版",
  "settings.updates.migration.description":
    "CloseCode Beta 目前正在迁移至 CloseCode 稳定版。请下载 {{version}} 版本，然后从磁盘映像安装 CloseCode，以继续接收更新。",
  "settings.updates.action.installing": "正在安装…",
  "settings.updates.toast.latest.title": "已是最新版本",
  "settings.updates.toast.latest.description": "你正在使用最新版本的 CloseCode。",
  ...
  "server.row.incompatible": "此服务器正在运行 CloseCode {{version}}，与此应用不兼容。请升级到 CloseCode V2 以继续。",
  ...
  "session.error.incompatible.description":
    "{{server}} 正在运行 CloseCode {{version}}，与此应用不兼容。请将服务器升级到 CloseCode V2 以继续。",
  ...
  "settings.about.description": "CloseCode ，开源编码代理",
  "settings.about.trademark": "CloseCode是Anomaly Innovations, Inc.的注册商标。",
  ...
  "ssh.stage.checking": "正在检查 CloseCode…",
  "ssh.stage.downloading": "正在下载服务器…",
  "ssh.stage.uploading": "正在上传服务器…",
  "ssh.stage.starting": "正在连接到 CloseCode…",
  "ssh.stage.ready": "已连接",
  ...
  "ssh.error.service": "SSH 已连接，但 CloseCode 服务器未准备就绪。",
  ...
  "server.connect.scan.description": "将摄像头对准 closecode pair 显示的二维码。",
  "server.connect.scan.invalid": "这不是 CloseCode 配对码。请扫描 closecode pair 显示的二维码。",
  ...
  "project.settings.name.description": "在 CloseCode 中此项目显示的名称",
  ...
  "project.settings.extensions.empty.mcps.description": "可用于 CloseCode 的 MCP 将显示在这里",
  "project.settings.extensions.empty.plugins.title": "尚无插件",
  "project.settings.extensions.empty.plugins.description": "可用于 CloseCode 的插件将显示在这里",
  "project.settings.extensions.empty.skills.title": "尚无技能",
  "project.settings.extensions.empty.skills.description": "可用于 CloseCode 的技能将显示在这里",
  ...
  "settings.workspaces.empty.description": "在 CloseCode 中创建的工作树将显示在此处",
