export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل CloseCode",
  "desktop.recovery.terminated": "توقفت نافذة CloseCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "CloseCode لا يستجيب",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من CloseCode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك CloseCode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في CloseCode.",
  ...
  "dialog.server.description": "تبديل خادم CloseCode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من CloseCode في {{distro}}…",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث CloseCode في {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "حدّث CloseCode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت CloseCode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن CloseCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على CloseCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح CloseCode.",
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من CloseCode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق CloseCode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن CloseCode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن CloseCode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم CloseCode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ CloseCode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور CloseCode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان CloseCode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة CloseCode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CloseCode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CloseCode.",
  ...
  "server.row.incompatible":
    "يعمل هذا الخادم بإصدار CloseCode \u2068{{version}}\u2069، وهو غير متوافق مع هذا التطبيق. رقِّه إلى CloseCode V2 للمتابعة.",
  ...
  "session.error.incompatible.description":
    "يعمل \u2068{{server}}\u2069 بإصدار CloseCode \u2068{{version}}\u2069، وهو غير متوافق مع هذا التطبيق. رقِّ الخادم إلى CloseCode V2 للمتابعة.",
  ...
  "settings.about.description": "\u2068CloseCode\u2069، وكيل البرمجة مفتوح المصدر",
  "settings.about.trademark": "\u2068CloseCode\u2069 علامة تجارية مسجلة لشركة \u2068Anomaly Innovations, Inc.\u2069",
  ...
  "ssh.stage.checking": "جارٍ التحقق من CloseCode…",
  "ssh.stage.downloading": "جارٍ تنزيل الخادم…",
  "ssh.stage.uploading": "جارٍ رفع الخادم…",
  "ssh.stage.starting": "جارٍ الاتصال بـ CloseCode…",
  ...
  "ssh.error.service": "اتصل SSH، لكن خادم CloseCode لم يصبح جاهزًا.",
  ...
  "server.connect.scan.description": "وجّه الكاميرا نحو رمز QR الذي يعرضه closecode pair.",
  "server.connect.scan.invalid": "هذا ليس رمز إقران CloseCode. امسح الرمز الذي يعرضه closecode pair.",
  ...
  "project.settings.name.description": "الاسم المعروض لهذا المشروع في جميع أنحاء CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "ستظهر هنا خوادم MCP المتاحة لـ CloseCode",
  "project.settings.extensions.empty.plugins.title": "لا توجد ملحقات بعد",
  "project.settings.extensions.empty.plugins.description": "ستظهر هنا الملحقات المتاحة لـ CloseCode",
  "project.settings.extensions.empty.skills.title": "لا توجد مهارات بعد",
  "project.settings.extensions.empty.skills.description": "ستظهر هنا المهارات المتاحة لـ CloseCode",
  ...
  "settings.workspaces.empty.description": "ستظهر هنا أشجار العمل المنشأة في CloseCode",
  ...
  "settings.updates.action.download": "تنزيل CloseCode",
  "settings.updates.migration.title": "الانتقال من الإصدار التجريبي إلى المستقر",
  "settings.updates.migration.description":
    "ينتقل CloseCode Beta حاليًا إلى CloseCode Stable. نزّل الإصدار \u2068{{version}}\u2069، ثم ثبّت CloseCode من صورة القرص للاستمرار في تلقي التحديثات.",
}
