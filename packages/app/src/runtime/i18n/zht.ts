...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CloseCode 載入失敗",
  "desktop.recovery.terminated": "CloseCode 視窗意外終止",
  "desktop.recovery.unresponsive": "CloseCode 沒有回應",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 CloseCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "CloseCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 CloseCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 CloseCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 CloseCode 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 CloseCode…",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 CloseCode 已就緒。",
  "wsl.onboarding.opencodeReady": "CloseCode 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 CloseCode。",
  "wsl.onboarding.installOpencode": "安裝 CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 CloseCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "CloseCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 CloseCode。",
  ...
  "toast.update.description": "CloseCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 CloseCode 團隊",
  ...
  "sidebar.gettingStarted.line1": "CloseCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 CloseCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 CloseCode 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 CloseCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 CloseCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 CloseCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 CloseCode 啟動時自動檢查更新",
  ...
  "settings.updates.action.download": "下載 CloseCode",
  "settings.updates.migration.title": "從 Beta 版移轉至穩定版",
  "settings.updates.migration.description":
    "CloseCode Beta 目前正在移轉至 CloseCode 穩定版。請下載 {{version}} 版本，然後從磁碟映像檔安裝 CloseCode，以繼續接收更新。",
  ...
  "server.row.incompatible": "此伺服器正在執行 CloseCode {{version}}，與此應用程式不相容。請升級至 CloseCode V2 以繼續。",
  ...
  "session.error.incompatible.description":
    "{{server}} 正在執行 CloseCode {{version}}，與此應用程式不相容。請將伺服器升級至 CloseCode V2 以繼續。",
  ...
  "settings.about.description": "CloseCode ，開源編碼代理",
  "settings.about.trademark": "CloseCode是Anomaly Innovations, Inc.的註冊商標。",
  ...
  "ssh.stage.checking": "正在檢查 CloseCode…",
  "ssh.stage.downloading": "正在下載伺服器…",
  "ssh.stage.uploading": "正在上傳伺服器…",
  "ssh.stage.starting": "正在連線至 CloseCode…",
  "ssh.stage.ready": "已連線",
  ...
  "ssh.error.service": "SSH 已連線，但 CloseCode 伺服器未準備就緒。",
  ...
  "server.connect.scan.description": "將攝影機對準 closecode pair 顯示的 QR 碼。",
  "server.connect.scan.invalid": "這不是 CloseCode 配對碼。請掃描 closecode pair 顯示的 QR 碼。",
  ...
  "project.settings.name.description": "此名稱會在 CloseCode 中的整個專案中顯示",
  ...
  "project.settings.extensions.empty.mcps.description": "可供 CloseCode 使用的 MCP 會顯示在此",
  "project.settings.extensions.empty.plugins.title": "尚無外掛程式",
  "project.settings.extensions.empty.plugins.description": "可供 CloseCode 使用的外掛程式會顯示在此",
  "project.settings.extensions.empty.skills.title": "尚無技能",
  "project.settings.extensions.empty.skills.description": "可供 CloseCode 使用的技能會顯示在此",
  ...
  "settings.workspaces.empty.description": "在 CloseCode 中建立的工作樹將顯示在此處",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：CloseCode 尚不支援 MCP 驗證。",
