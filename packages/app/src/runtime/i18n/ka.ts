export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "CloseCode მენიუ",
  ...
  "desktop.recovery.loadFailed": "CloseCode ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "CloseCode ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "CloseCode არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.opencodeMissing": "CloseCode არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია CloseCode",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები CloseCode-ში.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები CloseCode-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები CloseCode-ში.",
  ...
  "dialog.server.description": "გადართეთ რომელ CloseCode სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია CloseCode-ში {{distro}}…",
  "wsl.onboarding.updatingOpencode": "განახლება CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "CloseCode განახლება ხდება {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "განახლება CloseCode {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode მზად არის {{distro}}-ში.",
  "wsl.onboarding.opencodeReady": "CloseCode მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ CloseCode {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ CloseCode შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "CloseCode ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით CloseCode.",
  ...
  "toast.update.description": "CloseCode-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა CloseCode გუნდს",
  ...
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, CloseCode ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "CloseCode სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით CloseCode სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა CloseCode",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება CloseCode თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა CloseCode სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის CloseCode თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც CloseCode გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ CloseCode-ის უახლეს ვერსიას.",
  ...
  "server.row.incompatible":
    "ამ სერვერზე გაშვებულია CloseCode {{version}}, რომელიც ამ აპთან თავსებადი არ არის. გასაგრძელებლად განაახლეთ CloseCode V2-მდე.",
  ...
  "session.error.incompatible.description":
    "{{server}}-ზე გაშვებულია CloseCode {{version}}, რომელიც ამ აპთან თავსებადი არ არის. გასაგრძელებლად განაახლეთ სერვერი CloseCode V2-მდე.",
  ...
  "settings.about.description": "CloseCode, ღია კოდის მქონე კოდირების აგენტი",
  "settings.about.trademark": "CloseCode არის Anomaly Innovations, Inc.-ის რეგისტრირებული სავაჭრო ნიშანი.",
  ...
  "ssh.stage.checking": "CloseCode-ის შემოწმება…",
  "ssh.stage.downloading": "სერვერის გადმოწერა…",
  "ssh.stage.uploading": "სერვერის ატვირთვა…",
  "ssh.stage.starting": "კავშირის დამყარება CloseCode-თან…",
  ...
  "ssh.error.service": "SSH დაკავშირებულია, მაგრამ CloseCode სერვერი მზად არ გამხდარა.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "მიმართეთ კამერა closecode pair-ის მიერ ნაჩვენებ QR კოდზე.",
  "server.connect.scan.invalid":
    "ეს CloseCode-ის დაწყვილების კოდი არ არის. დაასკანირეთ closecode pair-ის მიერ ნაჩვენები კოდი.",
  ...
  "project.settings.name.description": "ეს სახელწოდება გამოჩნდება ამ პროექტისთვის CloseCode-ში",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, რომლებიც ხელმისაწვდომია CloseCode-ისთვის, გამოჩნდება აქ",
  "project.settings.extensions.empty.plugins.title": "ჯერ არ არის პლაგინები",
  "project.settings.extensions.empty.plugins.description": "CloseCode-ისთვის ხელმისაწვდომი პლაგინები აქ გამოჩნდება",
  "project.settings.extensions.empty.skills.title": "ჯერ არ არის უნარები",
  "project.settings.extensions.empty.skills.description": "CloseCode-ისთვის ხელმისაწვდომი უნარები აქ გამოჩნდება",
  ...
  "settings.workspaces.empty.description": "CloseCode-ში შექმნილი სამუშაო ხეები გამოჩნდება აქ",
  ...
  "settings.updates.action.download": "CloseCode-ის ჩამოტვირთვა",
  "settings.updates.migration.title": "Beta-დან Stable-ზე გადასვლა",
  "settings.updates.migration.description":
    "ამჟამად CloseCode Beta გადადის CloseCode Stable-ზე. ჩამოტვირთეთ ვერსია {{version}}, შემდეგ დააინსტალირეთ CloseCode დისკის ასლიდან, რათა განახლებების მიღება განაგრძოთ.",
