export const dict = {
  ...
  "desktop.recovery.loadFailed": "CloseCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "CloseCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "CloseCode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.opencodeMissing": "CloseCode pole sellesse distrosse installitud",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid CloseCode'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises CloseCode.",
  ...
  "dialog.server.description": "Lülitage, millise CloseCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode kontrollimine…",
  "wsl.onboarding.checkingOpencodeIn": "CloseCode kontrollimine asukohas {{distro}}…",
  "wsl.onboarding.updatingOpencode": "CloseCode värskendamine…",
  "wsl.onboarding.updatingOpencodeIn": "CloseCode värskendamine asukohas {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Värskenda CloseCode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige CloseCode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui CloseCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "CloseCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti CloseCode.",
  ...
  "toast.update.description": "Rakenduse CloseCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast CloseCode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, CloseCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "CloseCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage CloseCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke CloseCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas CloseCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas CloseCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas CloseCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui CloseCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse CloseCode uusimat versiooni.",
  ...
  "server.row.incompatible":
    "See server käitab CloseCode'i versiooni {{version}}, mis ei ühildu selle rakendusega. Jätkamiseks uuenda server CloseCode V2-le.",
  ...
  "session.error.incompatible.description":
    "{{server}} käitab CloseCode'i versiooni {{version}}, mis ei ühildu selle rakendusega. Jätkamiseks uuenda server CloseCode V2-le.",
  ...
  "settings.about.description": "CloseCode, avatud lähtekoodiga kodeerimisagent",
  "settings.about.trademark": "CloseCode on ettevõtte Anomaly Innovations, Inc. registreeritud kaubamärk.",
  ...
  "ssh.stage.checking": "CloseCode kontrollimine…",
  "ssh.stage.downloading": "Serveri allalaadimine…",
  "ssh.stage.uploading": "Serveri üleslaadimine…",
  "ssh.stage.starting": "Ühendamine seadmega CloseCode…",
  ...
  "ssh.error.service": "SSH on ühendatud, kuid server CloseCode ei saanud valmis.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Suunake oma kaamera koodile QR, mida näitab closecode pair.",
  "server.connect.scan.invalid": "See ei ole CloseCode sidumiskood. Skannige koodi, mida näitab closecode pair.",
  ...
  "project.settings.name.description": "Selle projekti jaoks kuvatud nimi kogu CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs, mis on saadaval CloseCode jaoks, kuvatakse siin",
  "project.settings.extensions.empty.plugins.title": "Pluginaid pole veel",
  "project.settings.extensions.empty.plugins.description": "CloseCode jaoks saadaolevad pistikprogrammid kuvatakse siin",
  "project.settings.extensions.empty.skills.title": "Oskusi veel pole",
  "project.settings.extensions.empty.skills.description": "Siin kuvatakse CloseCode jaoks saadaolevad oskused",
  ...
  "settings.workspaces.empty.description": "Siin kuvatakse programmis CloseCode loodud tööpuud",
  ...
  "settings.updates.action.download": "Laadi CloseCode alla",
  "settings.updates.migration.title": "Liigu beetaversioonilt stabiilsele versioonile",
  "settings.updates.migration.description":
    "Praegu liigub CloseCode Beta versioonile CloseCode Stable. Laadi alla versioon {{version}} ja installi CloseCode kettatõmmiselt, et jätkata uuenduste saamist.",
}
