export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "CloseCode menyusi",
  ...
  "desktop.recovery.loadFailed": "CloseCode yuklanmadi",
  "desktop.recovery.terminated": "CloseCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "CloseCode javob bermayapti",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va CloseCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va CloseCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va CloseCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi CloseCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode tekshirilmoqda…",
  "wsl.onboarding.checkingOpencodeIn": "CloseCode {{distro}} da tekshirilmoqda…",
  "wsl.onboarding.updatingOpencode": "CloseCode yangilanmoqda…",
  "wsl.onboarding.updatingOpencodeIn": "CloseCode {{distro}} da yangilanmoqda…",
  "wsl.onboarding.updateOpencodeIn": "CloseCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "CloseCode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "CloseCode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "CloseCode tayyor.",
  "wsl.onboarding.installOpencodeIn": "CloseCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "CloseCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CloseCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "CloseCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra CloseCode-ni qayta oching.",
  ...
  "toast.update.description": "CloseCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida CloseCode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, CloseCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "CloseCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi CloseCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "CloseCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "CloseCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "CloseCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "CloseCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "CloseCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz CloseCode oxirgi versiyasini ishga tushiryapsiz.",
  ...
  "server.row.incompatible":
    "Bu server ushbu ilovaga mos kelmaydigan CloseCode {{version}} versiyasini ishlatmoqda. Davom etish uchun uni CloseCode V2 versiyasiga yangilang.",
  ...
  "session.error.incompatible.description":
    "{{server}} ushbu ilovaga mos kelmaydigan CloseCode {{version}} versiyasini ishlatmoqda. Davom etish uchun serverni CloseCode V2 versiyasiga yangilang.",
  ...
  "settings.about.description": "CloseCode, ochiq manbali kodlash agenti",
  "settings.about.trademark": "CloseCode — Anomaly Innovations, Inc. kompaniyasining ro‘yxatdan o‘tgan savdo belgisi.",
  ...
  "ssh.stage.checking": "CloseCode tekshirilmoqda…",
  "ssh.stage.downloading": "Server yuklanmoqda…",
  "ssh.stage.uploading": "Server yuklanmoqda…",
  "ssh.stage.starting": "CloseCode ga ulanmoqda…",
  ...
  "ssh.error.service": "SSH ulandi, lekin CloseCode serveri tayyor emas.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Kamerani closecode pair koʻrsatgan QR kodga qarating.",
  "server.connect.scan.invalid": "Bu CloseCode ulash kodi emas. closecode pair koʻrsatgan kodni skanerlang.",
  ...
  "project.settings.name.description": "Ushbu loyiha uchun CloseCode bo'ylab ko'rsatilgan nom",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode uchun mavjud MCPlar shu yerda paydo bo'ladi",
  "project.settings.extensions.empty.plugins.title": "Hozircha plaginlar yo‘q",
  "project.settings.extensions.empty.plugins.description": "CloseCode uchun mavjud plaginlar shu yerda paydo bo'ladi",
  "project.settings.extensions.empty.skills.title": "Hali mahorat yo'q",
  "project.settings.extensions.empty.skills.description":
    "CloseCode uchun mavjud bo'lgan ko'nikmalar bu erda paydo bo'ladi",
  ...
  "settings.workspaces.empty.description": "CloseCode-da yaratilgan ishchi daraxtlar bu erda paydo bo'ladi",
  ...
  "settings.updates.action.download": "CloseCode-ni yuklab olish",
  "settings.updates.migration.title": "Beta-dan Stable-ga o‘tish",
  "settings.updates.migration.description":
    "Hozircha CloseCode Beta CloseCode Stable-ga o‘tmoqda. Yangilanishlarni olishda davom etish uchun {{version}} versiyasini yuklab oling, so‘ng CloseCode-ni disk tasviridan o‘rnating.",
