export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Документация",
  ...
  "desktop.menu.ariaLabel": "CloseCode меню",
  ...
  "desktop.recovery.loadFailed": "CloseCode не успя да се зареди",
  "desktop.recovery.terminated": "Прозорецът CloseCode приключи неочаквано",
  "desktop.recovery.unresponsive": "CloseCode не отговаря",
  ...
  "desktop.wsl.error.installOpencode": "Инсталирането на CloseCode е неуспешно",
  "desktop.wsl.error.alreadyAdded": "{{distro}} вече е добавен",
  "desktop.wsl.error.opencodeMissing": "CloseCode не е инсталиран в тази дистрибуция",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode е инсталиран, но не може да стартира",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode не е инсталиран в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode актуализацията приключи, но {{distro}} все още съобщава {{installed}}; очаквано {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безплатни модели, предоставени от CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Въведете своя {{provider}} API ключ, за да свържете акаунта си и да използвате {{provider}} модели в CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ви дава достъп до подбран набор от надеждни оптимизирани модели за кодиращи агенти.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "за да вземете вашия код за оторизация, за да свържете акаунта си и да използвате {{provider}} модели в CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и въведете кода по-долу, за да свържете акаунта си и да използвате {{provider}} модели в CloseCode.",
  ...
  "dialog.server.description": "Превключете към кой CloseCode сървър се свързва това приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверява се CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Проверява се CloseCode в {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Актуализиране на CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Актуализиране на CloseCode в {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Актуализирайте CloseCode в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Актуализация CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode е готов в {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode е готов.",
  "wsl.onboarding.installOpencodeIn": "Инсталирайте CloseCode в {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирайте CloseCode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) се изисква, преди CloseCode да може да добави WSL сървър",
  "wsl.onboarding.wslUnavailable.title": "WSL не е наличен",
  "wsl.onboarding.wslUnavailable.description": "CloseCode не можа да провери WSL на тази машина.",
  "wsl.onboarding.installWsl": "Инсталирайте WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирайте Windows, за да завършите инсталирането на WSL, след което отворете отново CloseCode.",
  ...
  "toast.update.description": "Вече е достъпна за инсталиране нова версия на CloseCode ({{version}}).",
  ...
  "error.page.report.prefix": "Моля, докладвайте тази грешка на екипа на CloseCode",
  ...
  "error.chain.mcpFailed":
    'MCP сървър "{{name}}" не успя. Имайте предвид, че CloseCode все още не поддържа MCP удостоверяване.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode включва безплатни модели, така че можете да започнете веднага.",
  ...
  "settings.desktop.wsl.description": "Стартирайте сървъра CloseCode вътре в WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете езика на дисплея за CloseCode",
  ...
  "settings.general.row.appearance.description": "Персонализирайте как изглежда CloseCode на вашето устройство",
  "settings.general.row.colorScheme.title": "Цветова схема",
  "settings.general.row.colorScheme.description": "Изберете дали CloseCode следва системната, светла или тъмна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Персонализирайте как е тематично CloseCode.",
  ...
  "settings.updates.row.startup.description": "Автоматично проверявайте за актуализации при стартиране на CloseCode",
  ...
  "settings.updates.toast.latest.description": "Вие използвате най-новата версия на CloseCode.",
  ...
  "server.row.incompatible":
    "Този сървър работи с CloseCode {{version}}, който не е съвместим с приложението. Надстройте го до CloseCode V2, за да продължите.",
  ...
  "session.error.incompatible.description":
    "{{server}} работи с CloseCode {{version}}, който не е съвместим с приложението. Надстройте сървъра до CloseCode V2, за да продължите.",
  ...
  "settings.about.description": "CloseCode, агентът за кодиране с отворен код",
  "settings.about.trademark": "CloseCode е регистрирана търговска марка на Anomaly Innovations, Inc.",
  ...
  "ssh.stage.starting": "Свързване с CloseCode…",
  ...
  "ssh.error.service": "SSH връзката е установена, но сървърът на CloseCode не е готов.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Насочете камерата към QR кода, показан от closecode pair.",
  "server.connect.scan.invalid": "Това не е код за сдвояване с CloseCode. Сканирайте кода, показан от closecode pair.",
  ...
  "project.settings.name.description": "Името, което се показва за този проект в CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "Наличните за CloseCode MCP сървъри ще се показват тук",
  "project.settings.extensions.empty.plugins.title": "Все още няма добавки",
  "project.settings.extensions.empty.plugins.description": "Наличните за CloseCode добавки ще се показват тук",
  "project.settings.extensions.empty.skills.title": "Все още няма умения",
  "project.settings.extensions.empty.skills.description": "Наличните за CloseCode умения ще се показват тук",
  ...
  "settings.workspaces.empty.description": "Създадените в CloseCode работни дървета ще се показват тук",
  ...
  "settings.updates.action.download": "Изтегляне на CloseCode",
  "settings.updates.migration.title": "Преминаване от Beta към Stable",
  "settings.updates.migration.description":
    "Засега CloseCode Beta преминава към CloseCode Stable. Изтеглете версия {{version}}, след което инсталирайте CloseCode от дисковия образ, за да продължите да получавате актуализации.",
