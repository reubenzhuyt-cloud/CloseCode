...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða CloseCode",
  "CloseCode-glugganum var óvænt lokað",
  "CloseCode svarar ekki",
  ...
  "CloseCode er ekki uppsett í {{distro}}",
  "Uppfærslu CloseCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í CloseCode.",
  ...
  "dialog.server.description": "Skiptu um hvaða CloseCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Athugar CloseCode í {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Uppfærir CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir CloseCode í {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu CloseCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp CloseCode í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en CloseCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "CloseCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan CloseCode aftur.",
  ...
  "toast.update.description": "Ný útgáfa af CloseCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til CloseCode teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, CloseCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "CloseCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "CloseCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu CloseCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir CloseCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig CloseCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort CloseCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig CloseCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar CloseCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af CloseCode.",
  ...
  "server.row.incompatible":
    "Þessi netþjónn keyrir CloseCode {{version}}, sem er ekki samhæft þessu forriti. Uppfærðu hann í CloseCode V2 til að halda áfram.",
  ...
  "session.error.incompatible.description":
    "{{server}} keyrir CloseCode {{version}}, sem er ekki samhæft þessu forriti. Uppfærðu netþjóninn í CloseCode V2 til að halda áfram.",
  ...
  "settings.about.description": "CloseCode, opinn kóðunaraðili",
  "settings.about.trademark": "CloseCode er skráð vörumerki Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Athugar CloseCode…",
  "ssh.stage.downloading": "Sækir miðlara…",
  "ssh.stage.uploading": "Hleður upp þjóni...",
  "ssh.stage.starting": "Tengist CloseCode…",
  ...
  "ssh.error.service": "SSH tengdur, en CloseCode þjónninn varð ekki tilbúinn.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Beindu myndavélinni þinni að QR kóðanum sem closecode pair sýnir.",
  "server.connect.scan.invalid": "Þetta er ekki CloseCode pörunarkóði. Skannaðu kóðann sem closecode pair sýnir.",
  ...
  "project.settings.name.description": "Nafnið sem sýnt er fyrir þetta verkefni í gegnum CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs í boði fyrir CloseCode mun birtast hér",
  "project.settings.extensions.empty.plugins.title": "Engar viðbætur ennþá",
  "project.settings.extensions.empty.plugins.description": "Viðbætur sem eru í boði fyrir CloseCode munu birtast hér",
  "project.settings.extensions.empty.skills.title": "Engar færni enn",
  "project.settings.extensions.empty.skills.description": "Hæfni í boði fyrir CloseCode mun birtast hér",
  ...
  "settings.workspaces.empty.description": "Vinnutré sem búin eru til í CloseCode munu birtast hér",
  ...
  "settings.updates.action.download": "Sækja CloseCode",
  "settings.updates.migration.title": "Fara úr Beta í Stöðuga útgáfu",
  "settings.updates.migration.description":
    "CloseCode Beta er um sinn að færast yfir í CloseCode Stable. Sæktu útgáfu {{version}} og settu síðan CloseCode upp úr diskmyndinni til að halda áfram að fá uppfærslur.",
}
