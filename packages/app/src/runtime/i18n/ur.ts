export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "CloseCode مینو",
  ...
  "desktop.recovery.loadFailed": "CloseCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "CloseCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "CloseCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "\u2068{{distro}}\u2069 پہلے ہی شامل ہے",
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹری بیوشن میں CloseCode انسٹال نہیں ہے",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.opencodeNotInstalled": "\u2068{{distro}}\u2069 میں CloseCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "CloseCode کی اپ ڈیٹ مکمل ہو گئی لیکن \u2068{{distro}}\u2069 اب بھی \u2068{{installed}}\u2069 کی اطلاع دے رہا ہے؛ متوقع ورژن \u2068{{expected}}\u2069 ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور CloseCode میں \u2068{{provider}}\u2069 ماڈلز استعمال کرنے کے لیے اپنی \u2068{{provider}}\u2069 API کلید درج کریں۔",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور CloseCode میں \u2068{{provider}}\u2069 ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور CloseCode میں \u2068{{provider}}\u2069 ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس CloseCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode چیک کیا جا رہا ہے…",
  "wsl.onboarding.checkingOpencodeIn": "\u2068{{distro}}\u2069 میں CloseCode چیک کیا جا رہا ہے…",
  "wsl.onboarding.updatingOpencode": "CloseCode کو اپ ڈیٹ کیا جا رہا ہے…",
  "wsl.onboarding.updatingOpencodeIn": "\u2068{{distro}}\u2069 میں CloseCode کو اپ ڈیٹ کیا جا رہا ہے…",
  "wsl.onboarding.updateOpencodeIn": "\u2068{{distro}}\u2069 میں CloseCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "CloseCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "CloseCode \u2068{{distro}}\u2069 میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "CloseCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "\u2068{{distro}}\u2069 میں CloseCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "CloseCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ CloseCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "CloseCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر CloseCode کو دوبارہ کھولیں۔",
  ...
  "toast.update.description": "CloseCode (\u2068{{version}}\u2069) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم CloseCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed":
    'MCP سرور "\u2068{{name}}\u2069" ناکام ہو گیا۔ نوٹ، CloseCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "CloseCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "CloseCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر CloseCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "CloseCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر CloseCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا CloseCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "CloseCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "CloseCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ CloseCode کا تازہ ترین ورژن چلا رہے ہیں۔",
  ...
  "server.row.incompatible":
    "یہ سرور CloseCode \u2068{{version}}\u2069 چلا رہا ہے، جو اس ایپ کے ساتھ مطابقت نہیں رکھتا۔ جاری رکھنے کے لیے اسے CloseCode V2 پر اپ گریڈ کریں۔",
  ...
  "session.error.incompatible.description":
    "\u2068{{server}}\u2069 پر CloseCode \u2068{{version}}\u2069 چل رہا ہے، جو اس ایپ کے ساتھ مطابقت نہیں رکھتا۔ جاری رکھنے کے لیے سرور کو CloseCode V2 پر اپ گریڈ کریں۔",
  ...
  "settings.about.description": "CloseCode، اوپن سورس کوڈنگ ایجنٹ",
  "settings.about.trademark": "CloseCode، Anomaly Innovations, Inc. کا رجسٹرڈ ٹریڈ مارک ہے۔",
  ...
  "ssh.stage.checking": "چیک کیا جا رہا ہے CloseCode…",
  "ssh.stage.downloading": "سرور ڈاؤن لوڈ ہو رہا ہے…",
  "ssh.stage.uploading": "سرور اپ لوڈ ہو رہا ہے…",
  "ssh.stage.starting": "CloseCode سے منسلک ہو رہا ہے…",
  ...
  "ssh.error.service": "SSH منسلک، لیکن CloseCode سرور تیار نہیں ہوا۔",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "یہ CloseCode جوڑا بنانے والا کوڈ نہیں ہے۔ اوپن کوڈ جوڑی کے ذریعہ دکھائے گئے کوڈ کو اسکین کریں۔",
  ...
  "project.settings.name.description": "پورے CloseCode میں اس پروجیکٹ کے لیے دکھایا گیا نام",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode کو دستیاب MCPs یہاں ظاہر ہوں گے۔",
  "project.settings.extensions.empty.plugins.title": "ابھی تک کوئی پلگ ان نہیں ہے۔",
  "project.settings.extensions.empty.plugins.description": "CloseCode کے لیے دستیاب پلگ انز یہاں ظاہر ہوں گے۔",
  "project.settings.extensions.empty.skills.title": "ابھی تک کوئی ہنر نہیں ہے۔",
  "project.settings.extensions.empty.skills.description": "CloseCode کو دستیاب مہارتیں یہاں ظاہر ہوں گی۔",
  ...
  "settings.workspaces.empty.description": "CloseCode میں بنائے گئے ورک ٹریس یہاں ظاہر ہوں گے۔",
  ...
  "settings.updates.action.download": "CloseCode ڈاؤن لوڈ کریں",
  "settings.updates.migration.title": "بیٹا سے مستحکم ورژن پر جائیں",
  "settings.updates.migration.description":
    "فی الحال CloseCode Beta کو CloseCode Stable میں منتقل کیا جا رہا ہے۔ ورژن \u2068{{version}}\u2069 ڈاؤن لوڈ کریں، پھر اپ ڈیٹس ملتے رہنے کے لیے ڈسک امیج سے CloseCode انسٹال کریں۔",
}
