export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "CloseCode meni",
  ...
  "desktop.recovery.loadFailed": "CloseCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno CloseCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "CloseCode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev CloseCode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.opencodeMissing": "CloseCode ni nameščen v tej distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev CloseCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v CloseCode.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom CloseCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje CloseCode …",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje CloseCode v {{distro}} …",
  "wsl.onboarding.updatingOpencode": "Posodabljanje CloseCode …",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje CloseCode v {{distro}} …",
  "wsl.onboarding.updateOpencodeIn": "Posodobite CloseCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite CloseCode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko CloseCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "CloseCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite CloseCode.",
  ...
  "toast.update.description": "Nova različica CloseCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi CloseCode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, CloseCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik CloseCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za CloseCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako CloseCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali CloseCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo CloseCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene CloseCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico CloseCode.",
  ...
  "server.row.incompatible":
    "Ta strežnik uporablja CloseCode {{version}}, ki ni združljiv s to aplikacijo. Za nadaljevanje ga nadgradite na CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "{{server}} uporablja CloseCode {{version}}, ki ni združljiv s to aplikacijo. Za nadaljevanje strežnik nadgradite na CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, odprtokodni agent za kodiranje",
  "settings.about.trademark": "CloseCode je registrirana blagovna znamka Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Preverjam CloseCode…",
  "ssh.stage.downloading": "Pridobivanje strežnika…",
  "ssh.stage.uploading": "Nalagam strežnik…",
  "ssh.stage.starting": "Povezovanje z CloseCode…",
  ...
  "ssh.error.service": "SSH povezan, vendar CloseCode strežnik ni postal pripravljen.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Usmerite kamero na QR kodo, ki jo prikaže closecode pair.",
  "server.connect.scan.invalid": "To ni CloseCode paritna koda. Skenirajte kodo, ki jo prikaže closecode pair.",
  ...
  "project.settings.name.description": "Ime, ki se prikaže za ta projekt v CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP-ji, na voljo za CloseCode, se bodo prikazali tukaj",
  "project.settings.extensions.empty.plugins.title": "Še ni vtičnikov",
  "project.settings.extensions.empty.plugins.description": "Vtičniki, na voljo za CloseCode, se bodo prikazali tukaj",
  "project.settings.extensions.empty.skills.title": "Še ni veščin",
  "project.settings.extensions.empty.skills.description": "Veščine, na voljo za CloseCode, se bodo prikazale tukaj",
  ...
  "settings.workspaces.empty.description": "Delovna drevesa, ustvarjena v CloseCode, se bodo prikazala tukaj",
  ...
  "settings.updates.action.download": "Prenesi CloseCode",
  "settings.updates.migration.title": "Prehod z Beta na Stable",
  "settings.updates.migration.description":
    "CloseCode Beta se za zdaj seli na CloseCode Stable. Prenesite različico {{version}}, nato pa namestite CloseCode iz slike diska, da boste še naprej prejemali posodobitve.",
