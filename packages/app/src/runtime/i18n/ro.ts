export const dict = {
  ...
  "desktop.menu.documentation": "Documentație CloseCode",
  ...
  "desktop.menu.ariaLabel": "Meniu CloseCode",
  ...
  "desktop.recovery.loadFailed": "CloseCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra CloseCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "CloseCode nu răspunde",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în CloseCode.",
  ...
  "dialog.server.description": "Schimbă serverul CloseCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică CloseCode în {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Se actualizează CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează CloseCode în {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Actualizează CloseCode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează CloseCode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca CloseCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "CloseCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide CloseCode.",
  ...
  "toast.update.description": "O nouă versiune CloseCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei CloseCode",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, CloseCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul CloseCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru CloseCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul CloseCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă CloseCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema CloseCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea CloseCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune CloseCode.",
  ...
  "desktop.cli.installed.message":
    "CLI a fost instalat în {{path}}\n\nReporniți terminalul pentru a utiliza comanda 'closecode'.",
  ...
  "server.row.incompatible":
    "Acest server rulează CloseCode {{version}}, care nu este compatibil cu această aplicație. Actualizați-l la CloseCode V2 pentru a continua.",
  ...
  "session.error.incompatible.description":
    "{{server}} rulează CloseCode {{version}}, care nu este compatibil cu această aplicație. Actualizați serverul la CloseCode V2 pentru a continua.",
  ...
  "settings.about.description": "CloseCode, agentul de codare open source",
  "settings.about.trademark": "CloseCode este o marcă înregistrată a Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Se verifică CloseCode…",
  "ssh.stage.downloading": "Se descarcă serverul…",
  "ssh.stage.uploading": "Se încarcă serverul…",
  "ssh.stage.starting": "Se conectează la CloseCode…",
  ...
  "ssh.error.service": "SSH s-a conectat, dar serverul CloseCode nu a devenit gata.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Îndreptați camera către codul QR afișat de closecode pair.",
  "server.connect.scan.invalid": "Acesta nu este un cod de asociere CloseCode. Scanați codul afișat de closecode pair.",
  ...
  "project.settings.name.description": "Numele afișat pentru acest proiect în CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponibil pentru CloseCode va apărea aici",
  "project.settings.extensions.empty.plugins.title": "Nu există încă pluginuri",
  "project.settings.extensions.empty.plugins.description": "Pluginurile disponibile pentru CloseCode vor apărea aici",
  "project.settings.extensions.empty.skills.title": "Nu există încă abilități",
  "project.settings.extensions.empty.skills.description": "Abilitățile disponibile pentru CloseCode vor apărea aici",
  ...
  "settings.workspaces.empty.description": "Arborele de lucru creat în CloseCode vor apărea aici",
  ...
  "settings.updates.action.download": "Descarcă CloseCode",
  "settings.updates.migration.title": "Treci de la Beta la Stabil",
  "settings.updates.migration.description":
    "Deocamdată, CloseCode Beta trece la CloseCode Stabil. Descarcă versiunea {{version}}, apoi instalează CloseCode din imaginea de disc pentru a continua să primești actualizări.",
}
