export const dict = {
  ...
  "ssh.stage.checking": "Comprobando CloseCode…",
  "ssh.stage.downloading": "Descargando servidor…",
  "ssh.stage.uploading": "Subiendo servidor…",
  "ssh.stage.starting": "Conectándose a CloseCode…",
  ...
  "ssh.error.service": "SSH se conectó, pero el servidor CloseCode no estuvo listo.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Apunte su cámara al código QR mostrado por closecode pair.",
  "server.connect.scan.invalid":
    "Este no es un código de emparejamiento CloseCode. Escanea el código mostrado por closecode pair.",
  ...
  "project.settings.name.description": "El nombre que se muestra para este proyecto en todo CloseCode.",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponible para CloseCode aparecerá aquí",
  "project.settings.extensions.empty.plugins.title": "Aún no hay complementos",
  "project.settings.extensions.empty.plugins.description": "Los complementos disponibles para CloseCode aparecerán aquí",
  "project.settings.extensions.empty.skills.title": "Aún no hay habilidades",
  "project.settings.extensions.empty.skills.description": "Las habilidades disponibles para CloseCode aparecerán aquí",
  ...
  "settings.workspaces.empty.description": "Los espacios de trabajo creados en CloseCode aparecerán aquí",
  ...
  "settings.about.description": "CloseCode, el agente de programación de código abierto",
  "settings.about.trademark": "CloseCode es una marca registrada de Anomaly Innovations, Inc.",
  ...
  "desktop.menu.documentation": "Documentación de CloseCode",
  ...
  "desktop.menu.ariaLabel": "Menú de CloseCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar CloseCode",
  "desktop.recovery.terminated": "La ventana de CloseCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "CloseCode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar CloseCode",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.opencodeMissing": "CloseCode no está instalado en esta distribución",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de CloseCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CloseCode.",
  ...
  "dialog.server.description": "Cambiar el servidor de CloseCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando CloseCode en {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Actualizando CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando CloseCode en {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Actualiza CloseCode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala CloseCode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que CloseCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CloseCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir CloseCode.",
  ...
  "toast.update.description": "Una nueva versión de CloseCode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de CloseCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: CloseCode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CloseCode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CloseCode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve CloseCode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CloseCode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CloseCode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CloseCode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CloseCode.",
  ...
  "desktop.cli.installed.message":
    "La CLI se ha instalado en {{path}}.\n\nReinicia el terminal para usar el comando 'closecode'.",
  ...
  "server.row.incompatible":
    "Este servidor ejecuta CloseCode {{version}}, que no es compatible con esta aplicación. Actualízalo a CloseCode V2 para continuar.",
  ...
  "session.error.incompatible.description":
    "{{server}} ejecuta CloseCode {{version}}, que no es compatible con esta aplicación. Actualiza el servidor a CloseCode V2 para continuar.",
  ...
  "settings.updates.action.download": "Descargar CloseCode",
  "settings.updates.migration.title": "Pasar de Beta a Estable",
  "settings.updates.migration.description":
    "Por ahora, CloseCode Beta se está trasladando a CloseCode Estable. Descarga la versión {{version}} e instala CloseCode desde la imagen de disco para seguir recibiendo actualizaciones.",
}
