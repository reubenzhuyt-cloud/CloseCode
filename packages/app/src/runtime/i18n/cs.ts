export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka CloseCode",
  ...
  "desktop.recovery.loadFailed": "CloseCode se nepodařilo načíst",
  "desktop.recovery.terminated": "CloseCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "CloseCode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.opencodeMissing": "CloseCode není v této distribuci nainstalováno",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v CloseCode.",
  ...
  "dialog.server.description": "Přepněte, ke kterému CloseCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola CloseCode v {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aktualizace CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace CloseCode v {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace CloseCode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte CloseCode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než CloseCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "CloseCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete CloseCode.",
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze CloseCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu CloseCode",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: CloseCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server CloseCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro CloseCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled CloseCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude CloseCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma CloseCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění CloseCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi CloseCode.",
  ...
  "server.row.incompatible":
    "Tento server používá CloseCode {{version}}, který není kompatibilní s touto aplikací. Chcete-li pokračovat, upgradujte jej na CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "{{server}} používá CloseCode {{version}}, který není kompatibilní s touto aplikací. Chcete-li pokračovat, upgradujte server na CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, open source kódovací agent",
  "settings.about.trademark": "CloseCode je registrovaná ochranná známka společnosti Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Kontrola CloseCode…",
  "ssh.stage.downloading": "Stahování serveru…",
  "ssh.stage.uploading": "Nahrávání serveru…",
  "ssh.stage.starting": "Připojování k CloseCode…",
  ...
  "ssh.error.service": "SSH se připojilo, ale server CloseCode nebyl připraven.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Namiřte kameru na QR kód zobrazený příkazem closecode pair.",
  "server.connect.scan.invalid": "Toto není párovací kód CloseCode. Naskenujte kód zobrazený příkazem closecode pair.",
  ...
  "project.settings.name.description": "Název zobrazovaný pro tento projekt v celém CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "Zde se zobrazí MCP dostupná pro CloseCode",
  "project.settings.extensions.empty.plugins.title": "Zatím žádné zásuvné moduly",
  "project.settings.extensions.empty.plugins.description": "Zde se zobrazí zásuvné moduly dostupné pro CloseCode",
  "project.settings.extensions.empty.skills.title": "Zatím žádné dovednosti",
  "project.settings.extensions.empty.skills.description": "Zde se zobrazí dovednosti dostupné pro CloseCode",
  ...
  "settings.workspaces.empty.description": "Zde se zobrazí pracovní stromy vytvořené v CloseCode",
  ...
  "settings.updates.action.download": "Stáhnout CloseCode",
  "settings.updates.migration.title": "Přejít z Beta na Stable",
  "settings.updates.migration.description":
    "CloseCode Beta prozatím přechází na CloseCode Stable. Stáhněte verzi {{version}} a poté nainstalujte CloseCode z obrazu disku, abyste mohli nadále dostávat aktualizace.",
