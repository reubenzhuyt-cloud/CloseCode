export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "CloseCode لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "CloseCode دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "CloseCode جواب نئیں دے رہیا",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی \u2068{{provider}}\u2069 API کلید درج کرو تے CloseCode وچ \u2068{{provider}}\u2069 ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے CloseCode وچ \u2068{{provider}}\u2069 ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے CloseCode وچ \u2068{{provider}}\u2069 ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس CloseCode سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode چیک کر رئے آں…",
  "wsl.onboarding.checkingOpencodeIn": "\u2068{{distro}}\u2069 چ CloseCode دی جانچ پڑتال…",
  "wsl.onboarding.updatingOpencode": "CloseCode نو اپ ڈیٹ کر رئے آں…",
  "wsl.onboarding.updatingOpencodeIn": "\u2068{{distro}}\u2069 وچ CloseCode نو اپ ڈیٹ کر رئے آں…",
  "wsl.onboarding.updateOpencodeIn": "\u2068{{distro}}\u2069 وچ CloseCode نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "CloseCode اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "CloseCode \u2068{{distro}}\u2069 چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "CloseCode تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "\u2068{{distro}}\u2069 وچ CloseCode انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "CloseCode انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CloseCode دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "CloseCode ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر CloseCode دوبارہ کھولو۔",
  ...
  "toast.update.description": "CloseCode (\u2068{{version}}\u2069) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع CloseCode ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed":
    'MCP سرور "\u2068{{name}}\u2069" ناکام ہو گیا۔ نوٹ، CloseCode ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "CloseCode چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر CloseCode سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "CloseCode لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے CloseCode کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا CloseCode سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "CloseCode نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں CloseCode لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی CloseCode دا تازہ ترین ورژن چلا رئے او۔",
  ...
  "server.row.incompatible":
    "ایس سرور تے CloseCode \u2068{{version}}\u2069 چل رہیا اے، جہڑا ایس ایپ نال میل نئیں کھاندا۔ جاری رکھن لئی اینوں CloseCode V2 تے اپ گریڈ کرو۔",
  ...
  "session.error.incompatible.description":
    "\u2068{{server}}\u2069 تے CloseCode \u2068{{version}}\u2069 چل رہیا اے، جہڑا ایس ایپ نال میل نئیں کھاندا۔ جاری رکھن لئی سرور نوں CloseCode V2 تے اپ گریڈ کرو۔",
  ...
  "settings.about.trademark": "CloseCode، Anomaly Innovations, Inc. دا رجسٹرڈ ٹریڈ مارک اے۔",
  ...
  "ssh.error.service": "SSH منسلک، لیکن CloseCode سرور تیار نئیں ہوا۔",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid":
    "یہ CloseCode جوڑا بنانے والا کوڈ نئیں اے۔ اوپن کوڈ جوڑی دے ذریعہ دکھائے گئے کوڈ کو اسکین کرو۔",
  ...
  "project.settings.name.description": "پورے CloseCode میں اس پروجیکٹ لئی دکھایا گیا نام",
  ...
  "project.settings.extensions.empty.plugins.description": "CloseCode لئی دستیاب پلگ انز یہاں ظاہر ہوں گے۔",
  ...
  "settings.updates.action.download": "CloseCode ڈاؤن لوڈ کرو",
  "settings.updates.migration.title": "بیٹا توں مستحکم ورژن ول جاؤ",
  "settings.updates.migration.description":
    "فی الحال CloseCode Beta نوں CloseCode Stable وچ منتقل کیتا جا ریا اے۔ ورژن \u2068{{version}}\u2069 ڈاؤن لوڈ کرو، فیر اپ ڈیٹ ملدے رہن لئی ڈسک امیج توں CloseCode انسٹال کرو۔",
}
