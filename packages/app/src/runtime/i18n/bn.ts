export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "CloseCode ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "CloseCode মেনু",
  ...
  "desktop.recovery.loadFailed": "CloseCode লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "CloseCode উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "CloseCode সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.opencodeMissing": "এই ডিস্ট্রোতে CloseCode ইনস্টল করা নেই",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "CloseCode আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি CloseCode দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং CloseCode-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen আপনাকে কোডিং এজেন্টের জন্য নির্ভরযোগ্য অপ্টিমাইজ করা মডেলের একটি কিউরেটেড সেটে অ্যাক্সেস দেয়।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি CloseCode-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি CloseCode-এ ব্যবহার করুন৷",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন CloseCode সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode পরীক্ষা করা হচ্ছে…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} এ CloseCode চেক করা হচ্ছে…",
  "wsl.onboarding.updatingOpencode": "আপডেট করা হচ্ছে CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-এ CloseCode আপডেট করা হচ্ছে…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-এ CloseCode আপডেট করুন।",
  "wsl.onboarding.updateOpencode": "CloseCode আপডেট করুন",
  "wsl.onboarding.opencodeReadyIn": "CloseCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.opencodeReady": "CloseCode প্রস্তুত।",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-এ CloseCode ইনস্টল করুন।",
  "wsl.onboarding.installOpencode": "CloseCode ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) CloseCode একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "CloseCode এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর CloseCode আবার খুলুন।",
  ...
  "toast.update.description": "CloseCode ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি CloseCode টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, CloseCode এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "CloseCode বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "CloseCode ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে CloseCode সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "CloseCode-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে CloseCode কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "CloseCode সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে CloseCode থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "CloseCode চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি CloseCode এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
  ...
  "server.row.incompatible":
    "এই সার্ভারে CloseCode {{version}} চলছে, যা এই অ্যাপের সঙ্গে সামঞ্জস্যপূর্ণ নয়। চালিয়ে যেতে এটিকে CloseCode V2-এ আপগ্রেড করুন।",
  ...
  "session.error.incompatible.description":
    "{{server}}-এ CloseCode {{version}} চলছে, যা এই অ্যাপের সঙ্গে সামঞ্জস্যপূর্ণ নয়। চালিয়ে যেতে সার্ভারটি CloseCode V2-এ আপগ্রেড করুন।",
  ...
  "settings.about.description": "CloseCode, ওপেন সোর্স কোডিং এজেন্ট",
  "settings.about.trademark": "CloseCode, Anomaly Innovations, Inc.-এর নিবন্ধিত ট্রেডমার্ক।",
  ...
  "ssh.stage.checking": "পরীক্ষা করা হচ্ছে CloseCode…",
  "ssh.stage.downloading": "সার্ভার ডাউনলোড হচ্ছে...",
  "ssh.stage.uploading": "সার্ভার আপলোড হচ্ছে...",
  "ssh.stage.starting": "CloseCode এর সাথে সংযোগ করা হচ্ছে…",
  ...
  "ssh.error.service": "SSH সংযুক্ত, কিন্তু CloseCode সার্ভার প্রস্তুত হয়নি৷",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "এটি একটি CloseCode পেয়ারিং কোড নয়৷ ওপেনকোড পেয়ার দ্বারা দেখানো কোডটি স্ক্যান করুন।",
  ...
  "project.settings.name.description": "CloseCode জুড়ে এই প্রকল্পের নাম দেখানো হয়েছে",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode-এর কাছে উপলব্ধ MCPগুলি এখানে প্রদর্শিত হবে৷",
  "project.settings.extensions.empty.plugins.title": "এখনো কোনো প্লাগইন নেই",
  "project.settings.extensions.empty.plugins.description": "CloseCode এ উপলব্ধ প্লাগইনগুলি এখানে উপস্থিত হবে৷",
  "project.settings.extensions.empty.skills.title": "এখনো কোনো দক্ষতা নেই",
  "project.settings.extensions.empty.skills.description": "CloseCode এর কাছে উপলব্ধ দক্ষতাগুলি এখানে প্রদর্শিত হবে৷",
  ...
  "settings.workspaces.empty.description": "CloseCode-এ তৈরি ওয়ার্কট্রিগুলি এখানে উপস্থিত হবে৷",
  ...
  "settings.updates.action.download": "CloseCode ডাউনলোড করুন",
  "settings.updates.migration.title": "বেটা থেকে স্থিতিশীল সংস্করণে যান",
  "settings.updates.migration.description":
    "আপাতত CloseCode Beta, CloseCode Stable-এ স্থানান্তরিত হচ্ছে। {{version}} সংস্করণ ডাউনলোড করুন, তারপর আপডেট পাওয়া অব্যাহত রাখতে ডিস্ক ইমেজ থেকে CloseCode ইনস্টল করুন।",
}
