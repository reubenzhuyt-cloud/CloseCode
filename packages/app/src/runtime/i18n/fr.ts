export const dict = {
  ...
  "ssh.error.service": "SSH s'est connecté, mais le serveur CloseCode n'est pas prêt.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Pointez votre appareil photo vers le code QR affiché par closecode pair.",
  "server.connect.scan.invalid":
    "Il ne s'agit pas d'un code d'appairage CloseCode. Scannez le code affiché par closecode pair.",
  ...
  "project.settings.name.description": "Le nom affiché pour ce projet dans CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponible pour CloseCode apparaîtra ici",
  "project.settings.extensions.empty.plugins.title": "Pas encore de plugin",
  "project.settings.extensions.empty.plugins.description": "Les plugins disponibles pour CloseCode apparaîtront ici",
  "project.settings.extensions.empty.skills.title": "Aucune compétence pour l'instant",
  "project.settings.extensions.empty.skills.description": "Les compétences disponibles pour CloseCode apparaîtront ici",
  ...
  "settings.workspaces.empty.description": "Les espaces de travail créés dans CloseCode apparaîtront ici",
  ...
  "settings.about.description": "CloseCode, l’agent de programmation open source",
  "settings.about.trademark": "CloseCode est une marque déposée d’Anomaly Innovations, Inc.",
  ...
  "desktop.menu.documentation": "Documentation d'CloseCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'CloseCode",
  "desktop.recovery.terminated": "La fenêtre CloseCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "CloseCode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'CloseCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.opencodeMissing": "CloseCode n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'CloseCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CloseCode.",
  ...
  "dialog.server.description": "Changez le serveur CloseCode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'CloseCode dans {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'CloseCode dans {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour CloseCode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez CloseCode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'CloseCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "CloseCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez CloseCode.",
  ...
  "toast.update.description":
    "Une nouvelle version d'CloseCode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CloseCode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CloseCode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CloseCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CloseCode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CloseCode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CloseCode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CloseCode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CloseCode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CloseCode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CloseCode.",
  ...
  "desktop.cli.installed.message":
    "La CLI a été installée dans {{path}}.\n\nRedémarrez votre terminal pour utiliser la commande 'closecode'.",
  ...
  "server.row.incompatible":
    "Ce serveur exécute CloseCode {{version}}, qui n'est pas compatible avec cette application. Mettez-le à niveau vers CloseCode V2 pour continuer.",
  ...
  "session.error.incompatible.description":
    "{{server}} exécute CloseCode {{version}}, qui n'est pas compatible avec cette application. Mettez le serveur à niveau vers CloseCode V2 pour continuer.",
  ...
  "settings.updates.action.download": "Télécharger CloseCode",
  "settings.updates.migration.title": "Passer de la version bêta à la version stable",
  "settings.updates.migration.description":
    "Pour le moment, CloseCode Beta passe à CloseCode Stable. Téléchargez la version {{version}}, puis installez CloseCode depuis l’image disque pour continuer à recevoir les mises à jour.",
}
