export const dict = {
  ...
  "desktop.recovery.loadFailed": "CloseCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap CloseCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "CloseCode tidak memberi respons",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam CloseCode.",
  ...
  "dialog.server.description": "Tukar pelayan CloseCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak CloseCode dalam {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini CloseCode dalam {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini CloseCode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang CloseCode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CloseCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CloseCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula CloseCode.",
  ...
  "toast.update.description": "Versi baharu CloseCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan CloseCode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, CloseCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan CloseCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk CloseCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa CloseCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada CloseCode mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila CloseCode dilancarkan",
  ...
  "settings.updates.action.download": "Muat turun CloseCode",
  "settings.updates.migration.title": "Beralih daripada Beta kepada Stabil",
  "settings.updates.migration.description":
    "Buat masa ini, CloseCode Beta sedang beralih kepada CloseCode Stabil. Muat turun versi {{version}}, kemudian pasang CloseCode daripada imej cakera untuk terus menerima kemas kini.",
  "settings.updates.action.installing": "Sedang memasang…",
  "settings.updates.toast.latest.title": "Anda sudah terkini",
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini CloseCode.",
  ...
  "server.row.incompatible":
    "Pelayan ini menjalankan CloseCode {{version}}, yang tidak serasi dengan aplikasi ini. Tingkatkan kepada CloseCode V2 untuk meneruskan.",
  ...
  "session.error.incompatible.description":
    "{{server}} menjalankan CloseCode {{version}}, yang tidak serasi dengan aplikasi ini. Tingkatkan pelayan kepada CloseCode V2 untuk meneruskan.",
  ...
  "settings.about.description": "CloseCode, ejen pengekodan sumber terbuka",
  "settings.about.trademark": "CloseCode ialah tanda dagangan berdaftar Anomaly Innovations, Inc.",
  ...
  "ssh.stage.starting": "Menyambung ke CloseCode…",
  ...
  "ssh.error.service": "SSH bersambung, tetapi pelayan CloseCode tidak bersedia.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Ini bukan kod pasangan CloseCode. Imbas kod yang ditunjukkan oleh pasangan opencode.",
  ...
  "project.settings.name.description": "Nama yang ditunjukkan untuk projek ini di seluruh CloseCode",
  ...
  "project.settings.extensions.empty.skills.description": "Kemahiran yang tersedia untuk CloseCode akan muncul di sini",
  ...
  "settings.workspaces.empty.description": "Worktree yang dibuat dalam CloseCode akan muncul di sini",
