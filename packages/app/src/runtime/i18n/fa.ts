export const dict = {
  ...
  "desktop.menu.documentation": "مستندات CloseCode",
  ...
  "desktop.menu.ariaLabel": "منوی CloseCode",
  ...
  "desktop.recovery.loadFailed": "CloseCode بارگیری نشد",
  "desktop.recovery.terminated": "پنجره CloseCode به طور غیرمنتظره ای خاتمه یافت",
  "desktop.recovery.unresponsive": "CloseCode پاسخ نمی دهد",
  ...
  "dialog.model.unpaid.freeModels.title": "مدل های رایگان ارائه شده توسط CloseCode",
  ...
  "provider.connect.apiKey.description":
    "کلید API سرویس {{provider}} را وارد کنید تا حساب شما متصل شود و بتوانید از مدل‌های {{provider}} در CloseCode استفاده کنید.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen به شما امکان دسترسی به مجموعه‌ای از مدل‌های بهینه‌شده قابل اعتماد را برای عوامل کدنویسی می‌دهد.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " برای جمع آوری کد مجوز برای اتصال حساب خود و استفاده از مدل های {{provider}} در CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " و کد زیر را برای اتصال اکانت خود وارد کنید و از مدل های {{provider}} در CloseCode استفاده کنید.",
  ...
  "dialog.server.description": "این برنامه به کدام سرور CloseCode متصل است، تغییر دهید.",
  ...
  "wsl.onboarding.checkingOpencode": "در حال بررسی CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "بررسی CloseCode در {{distro}}…",
  "wsl.onboarding.updatingOpencode": "در حال به روز رسانی CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "به روز رسانی CloseCode در {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "CloseCode را در {{distro}} به روز کنید.",
  "wsl.onboarding.updateOpencode": "CloseCode را به روز کنید",
  "wsl.onboarding.opencodeReadyIn": "CloseCode در {{distro}} آماده است.",
  "wsl.onboarding.opencodeReady": "CloseCode آماده است.",
  "wsl.onboarding.installOpencodeIn": "CloseCode را در {{distro}} نصب کنید.",
  "wsl.onboarding.installOpencode": "CloseCode را نصب کنید",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode نصب نشده است",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (زیر سیستم Windows برای Linux) قبل از اینکه CloseCode بتواند یک سرور WSL اضافه کند لازم است",
  "wsl.onboarding.wslUnavailable.title": "WSL در دسترس نیست",
  "wsl.onboarding.wslUnavailable.description": "CloseCode نتوانست WSL را در این دستگاه تأیید کند.",
  "wsl.onboarding.installWsl": "WSL را نصب کنید",
  "wsl.onboarding.windowsRestartRequired":
    "Windows را مجددا راه اندازی کنید تا نصب WSL به پایان برسد، سپس CloseCode را دوباره باز کنید.",
  ...
  "toast.update.description": "نسخه جدیدی از CloseCode ({{version}}) اکنون برای نصب در دسترس است.",
  ...
  "error.page.report.prefix": "لطفاً این خطا را به تیم CloseCode گزارش دهید",
  ...
  "error.chain.mcpFailed":
    'سرور MCP "{{name}}" ناموفق بود. توجه داشته باشید، CloseCode هنوز از احراز هویت MCP پشتیبانی نمی کند.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode شامل مدل های رایگان است، بنابراین می توانید بلافاصله شروع کنید.",
  ...
  "settings.desktop.wsl.description": "سرور CloseCode را در داخل WSL روی Windows اجرا کنید.",
  ...
  "settings.general.row.language.description": "زبان نمایش را برای CloseCode تغییر دهید",
  ...
  "settings.general.row.appearance.description": "نحوه ظاهر CloseCode را در دستگاه خود سفارشی کنید",
  "settings.general.row.colorScheme.title": "طرح رنگ",
  "settings.general.row.colorScheme.description": "انتخاب کنید که آیا CloseCode از تم سیستمی، روشن یا تیره پیروی می کند",
  "settings.general.row.theme.title": "موضوع",
  "settings.general.row.theme.description": "نحوه مضمون سازی CloseCode را سفارشی کنید.",
  ...
  "settings.updates.row.startup.description": "هنگام راه‌اندازی CloseCode، به‌روزرسانی‌ها را به‌طور خودکار بررسی کنید",
  ...
  "settings.updates.toast.latest.description": "شما آخرین نسخه CloseCode را اجرا می کنید.",
  ...
  "server.row.incompatible":
    "این سرور CloseCode \u2068{{version}}\u2069 را اجرا می‌کند که با این برنامه سازگار نیست. برای ادامه، آن را به CloseCode V2 ارتقا دهید.",
  ...
  "session.error.incompatible.description":
    "\u2068{{server}}\u2069 نسخه CloseCode \u2068{{version}}\u2069 را اجرا می‌کند که با این برنامه سازگار نیست. برای ادامه، سرور را به CloseCode V2 ارتقا دهید.",
  ...
  "settings.about.description": "\u2068CloseCode\u2069، عامل کدنویسی متن‌باز",
  "settings.about.trademark": "\u2068CloseCode\u2069 علامت تجاری ثبت‌شدهٔ \u2068Anomaly Innovations, Inc.\u2069 است",
  ...
  "ssh.stage.checking": "در حال بررسی CloseCode…",
  "ssh.stage.downloading": "در حال بارگیری سرور…",
  "ssh.stage.uploading": "در حال بارگذاری سرور…",
  "ssh.stage.starting": "در حال اتصال به CloseCode…",
  ...
  "ssh.error.service": "SSH متصل شد، اما سرور CloseCode آماده نشد.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "دوربین را به‌سمت کد QR نمایش‌داده‌شده توسط closecode pair بگیرید.",
  "server.connect.scan.invalid": "این کد جفت‌سازی CloseCode نیست. کدی را پویش کنید که closecode pair نشان می‌دهد.",
  ...
  "project.settings.name.description": "نامی که برای این پروژه در سراسر CloseCode نشان داده می‌شود",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPهای در دسترس CloseCode اینجا ظاهر می‌شوند",
  "project.settings.extensions.empty.plugins.title": "هنوز افزونه‌ای وجود ندارد",
  "project.settings.extensions.empty.plugins.description": "افزونه‌های در دسترس CloseCode اینجا ظاهر می‌شوند",
  "project.settings.extensions.empty.skills.title": "هنوز مهارتی وجود ندارد",
  "project.settings.extensions.empty.skills.description": "مهارت‌های در دسترس CloseCode اینجا ظاهر می‌شوند",
  ...
  "settings.workspaces.empty.description": "درخت‌های کار ایجادشده در CloseCode اینجا ظاهر می‌شوند",
  ...
  "settings.updates.action.download": "دانلود CloseCode",
  "settings.updates.migration.title": "انتقال از بتا به پایدار",
  "settings.updates.migration.description":
    "در حال حاضر CloseCode Beta به CloseCode Stable منتقل می‌شود. نسخهٔ \u2068{{version}}\u2069 را دانلود کنید، سپس برای ادامهٔ دریافت به‌روزرسانی‌ها CloseCode را از تصویر دیسک نصب کنید.",
}
