...
export const dict = {
  ...
  "ssh.error.service": "SSH koblet til, men CloseCode-serveren ble ikke klar.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Pek kameraet mot QR-koden vist av closecode pair.",
  "server.connect.scan.invalid": "Dette er ikke en CloseCode-paringskode. Skann koden vist av closecode pair.",
  ...
  "project.settings.name.description": "Navnet som vises for dette prosjektet gjennom hele CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tilgjengelig for CloseCode vil vises her",
  "project.settings.extensions.empty.plugins.title": "Ingen plugins ennå",
  "project.settings.extensions.empty.plugins.description": "Plugins tilgjengelig for CloseCode vil vises her",
  "project.settings.extensions.empty.skills.title": "Ingen ferdigheter ennå",
  "project.settings.extensions.empty.skills.description": "Ferdigheter tilgjengelig for CloseCode vil vises her",
  ...
  "settings.workspaces.empty.description": "Arbeidstre opprettet i CloseCode vil vises her",
  ...
  "settings.about.description": "CloseCode, kodeagenten med åpen kildekode",
  "settings.about.trademark": "CloseCode er et registrert varemerke for Anomaly Innovations, Inc.",
  ...
  "desktop.menu.documentation": "CloseCode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "CloseCode-meny",
  ...
  "desktop.recovery.loadFailed": "CloseCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "CloseCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "CloseCode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av CloseCode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.opencodeMissing": "CloseCode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av CloseCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CloseCode.",
  ...
  "dialog.server.description": "Bytt hvilken CloseCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CloseCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CloseCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CloseCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CloseCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CloseCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CloseCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om CloseCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i CloseCode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CloseCode starter",
  ...
  "settings.updates.toast.latest.title": "CloseCode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CloseCode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker CloseCode i {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Oppdaterer CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer CloseCode i {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Oppdater CloseCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer CloseCode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før CloseCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "CloseCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter CloseCode på nytt.",
  ...
  "desktop.cli.installed.message":
    "CLI-en ble installert i {{path}}.\n\nStart terminalen på nytt for å bruke kommandoen 'closecode'.",
  ...
  "server.row.incompatible":
    "Denne serveren kjører CloseCode {{version}}, som ikke er kompatibel med denne appen. Oppgrader den til CloseCode V2 for å fortsette.",
  ...
  "session.error.incompatible.description":
    "{{server}} kjører CloseCode {{version}}, som ikke er kompatibel med denne appen. Oppgrader serveren til CloseCode V2 for å fortsette.",
  ...
  "settings.updates.action.download": "Last ned CloseCode",
  "settings.updates.migration.title": "Bytt fra Beta til Stabil",
  "settings.updates.migration.description":
    "CloseCode Beta flyttes foreløpig til CloseCode Stabil. Last ned versjon {{version}}, og installer deretter CloseCode fra diskavbildningen for å fortsette å motta oppdateringer.",
