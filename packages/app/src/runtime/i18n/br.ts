export const dict = {
  ...
  "ssh.error.service": "SSH conectado, mas o servidor CloseCode não ficou pronto.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Aponte sua câmera para o código QR mostrado por closecode pair.",
  "server.connect.scan.invalid":
    "Este não é um código de emparelhamento CloseCode. Digitalize o código mostrado por closecode pair.",
  ...
  "project.settings.name.description": "O nome mostrado para este projeto em CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponível para CloseCode aparecerá aqui",
  "project.settings.extensions.empty.plugins.title": "Ainda não há plug-ins",
  "project.settings.extensions.empty.plugins.description": "Os plug-ins disponíveis para CloseCode aparecerão aqui",
  "project.settings.extensions.empty.skills.title": "Nenhuma habilidade ainda",
  "project.settings.extensions.empty.skills.description": "As habilidades disponíveis para CloseCode aparecerão aqui",
  ...
  "settings.workspaces.empty.description": "As espaços de trabalho criadas em CloseCode aparecerão aqui",
  ...
  "settings.about.description": "CloseCode, o agente de programação de código aberto",
  "settings.about.trademark": "CloseCode é uma marca registrada da Anomaly Innovations, Inc.",
  ...
  "desktop.menu.documentation": "Documentação do CloseCode",
  ...
  "desktop.menu.ariaLabel": "Menu do CloseCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o CloseCode",
  "desktop.recovery.terminated": "A janela do CloseCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O CloseCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do CloseCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O CloseCode não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O CloseCode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O CloseCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do CloseCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CloseCode.",
  ...
  "dialog.server.description": "Trocar para qual servidor CloseCode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o CloseCode em {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Atualizando o CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o CloseCode em {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Atualize o CloseCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o CloseCode",
  "wsl.onboarding.opencodeReadyIn": "O CloseCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O CloseCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o CloseCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o CloseCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O CloseCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o CloseCode novamente.",
  ...
  "toast.update.description": "Uma nova versão do CloseCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CloseCode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CloseCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CloseCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CloseCode",
  ...
  "settings.general.row.appearance.description": "Personalize como o CloseCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CloseCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CloseCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CloseCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CloseCode.",
  ...
  "server.row.incompatible":
    "Este servidor está executando o CloseCode {{version}}, que não é compatível com este aplicativo. Atualize-o para o CloseCode V2 para continuar.",
  ...
  "session.error.incompatible.description":
    "{{server}} está executando o CloseCode {{version}}, que não é compatível com este aplicativo. Atualize o servidor para o CloseCode V2 para continuar.",
  ...
  "settings.updates.action.download": "Baixar o CloseCode",
  "settings.updates.migration.title": "Migrar da versão Beta para a Estável",
  "settings.updates.migration.description":
    "Por enquanto, o CloseCode Beta está migrando para o CloseCode Estável. Baixe a versão {{version}} e instale o CloseCode pela imagem de disco para continuar recebendo atualizações.",
}
