export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "CloseCode कागजात",
  ...
  "desktop.menu.ariaLabel": "CloseCode मेनु",
  ...
  "desktop.recovery.loadFailed": "CloseCode लोड हुन सकेन",
  "desktop.recovery.terminated": "CloseCode विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "CloseCode ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode स्थापना असफल भयो",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहिले नै थपिएको छ",
  "desktop.wsl.error.opencodeMissing": "CloseCode यस distro मा स्थापित छैन",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "CloseCode अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र CloseCode मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ले तपाईंलाई कोडिङ एजेन्टहरूका लागि भरपर्दो अनुकूलित मोडेलहरूको क्युरेट गरिएको सेटमा पहुँच दिन्छ।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र CloseCode मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू CloseCode मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.server.description": "यो एप जडान भएको CloseCode सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode जाँच गर्दै…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} मा CloseCode जाँच गर्दै…",
  "wsl.onboarding.updatingOpencode": "अद्यावधिक गर्दै CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} मा CloseCode अद्यावधिक गर्दै…",
  "wsl.onboarding.updateOpencodeIn": "अपडेट गर्नुहोस् CloseCode {{distro}} मा।",
  "wsl.onboarding.updateOpencode": "अपडेट गर्नुहोस् CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode {{distro}} मा तयार छ।",
  "wsl.onboarding.opencodeReady": "CloseCode तयार छ।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} मा CloseCode स्थापना गर्नुहोस्।",
  "wsl.onboarding.installOpencode": "CloseCode स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) CloseCode ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "CloseCode ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि CloseCode पुन: खोल्नुहोस्।",
  ...
  "toast.update.description": "CloseCode ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि CloseCode टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, CloseCode ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "CloseCode मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "app.name.desktop": "CloseCode डेस्कटप",
  ...
  "settings.desktop.wsl.description": "CloseCode सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "CloseCode को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा CloseCode कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "CloseCode ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी CloseCode विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "CloseCode सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं CloseCode को नवीनतम संस्करण चलाइरहनुभएको छ।",
  ...
  "server.row.incompatible":
    "यो सर्भरमा CloseCode {{version}} चलिरहेको छ, जुन यस एपसँग मिल्दैन। जारी राख्न यसलाई CloseCode V2 मा अद्यावधिक गर्नुहोस्।",
  ...
  "session.error.incompatible.description":
    "{{server}} मा CloseCode {{version}} चलिरहेको छ, जुन यस एपसँग मिल्दैन। जारी राख्न सर्भरलाई CloseCode V2 मा अद्यावधिक गर्नुहोस्।",
  ...
  "settings.about.description": "CloseCode, खुला स्रोत कोडिङ एजेन्ट",
  "settings.about.trademark": "CloseCode, Anomaly Innovations, Inc. को दर्ता गरिएको ट्रेडमार्क हो।",
  ...
  "ssh.stage.checking": "जाँच गर्दै CloseCode…",
  "ssh.stage.downloading": "सर्भर डाउनलोड गर्दै...",
  "ssh.stage.uploading": "सर्भर अपलोड गर्दै...",
  "ssh.stage.starting": "CloseCode मा जडान गर्दै…",
  ...
  "ssh.error.service": "SSH जडान भयो, तर CloseCode सर्भर तयार भएन।",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "यो एक CloseCode जोडा कोड होइन। ओपनकोड जोडी द्वारा देखाइएको कोड स्क्यान गर्नुहोस्।",
  ...
  "project.settings.name.description": "यस परियोजनाको नाम CloseCode भरि देखाइएको छ",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode मा उपलब्ध MCPs यहाँ देखा पर्नेछ",
  "project.settings.extensions.empty.plugins.title": "अहिलेसम्म कुनै प्लगइनहरू छैनन्",
  "project.settings.extensions.empty.plugins.description": "CloseCode मा उपलब्ध प्लगइनहरू यहाँ देखिनेछन्",
  "project.settings.extensions.empty.skills.title": "अझै सीप छैन",
  "project.settings.extensions.empty.skills.description": "CloseCode मा उपलब्ध सीपहरू यहाँ देखिनेछन्",
  ...
  "settings.workspaces.empty.description": "CloseCode मा सिर्जना गरिएका Worktrees यहाँ देखिनेछन्",
  ...
  "settings.updates.action.download": "CloseCode डाउनलोड गर्नुहोस्",
  "settings.updates.migration.title": "बेटाबाट स्थिर संस्करणमा जानुहोस्",
  "settings.updates.migration.description":
    "अहिलेलाई CloseCode Beta लाई CloseCode Stable मा सारिँदै छ। संस्करण {{version}} डाउनलोड गर्नुहोस्, त्यसपछि अपडेटहरू पाइरहन डिस्क इमेजबाट CloseCode स्थापना गर्नुहोस्।",
}
