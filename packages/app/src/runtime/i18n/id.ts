export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi CloseCode",
  ...
  "desktop.recovery.loadFailed": "CloseCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela CloseCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "CloseCode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi CloseCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.opencodeMissing": "CloseCode belum terinstal di distro ini",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan CloseCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di CloseCode.",
  ...
  "dialog.server.description": "Ganti server CloseCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa CloseCode di {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Memperbarui CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui CloseCode di {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Perbarui CloseCode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal CloseCode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CloseCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CloseCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali CloseCode.",
  ...
  "toast.update.description": "Versi baru CloseCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim CloseCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: CloseCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server CloseCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk CloseCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan CloseCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah CloseCode mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema CloseCode.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat CloseCode diluncurkan",
  ...
  "settings.updates.action.download": "Unduh CloseCode",
  "settings.updates.migration.title": "Beralih dari Beta ke Stabil",
  "settings.updates.migration.description":
    "Untuk saat ini, CloseCode Beta sedang beralih ke CloseCode Stabil. Unduh versi {{version}}, lalu instal CloseCode dari citra diska agar terus menerima pembaruan.",
  "settings.updates.action.installing": "Menginstal…",
  "settings.updates.toast.latest.title": "Versi Anda sudah terbaru",
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru CloseCode.",
  ...
  "server.row.incompatible":
    "Server ini menjalankan CloseCode {{version}}, yang tidak kompatibel dengan aplikasi ini. Tingkatkan ke CloseCode V2 untuk melanjutkan.",
  ...
  "session.error.incompatible.description":
    "{{server}} menjalankan CloseCode {{version}}, yang tidak kompatibel dengan aplikasi ini. Tingkatkan server ke CloseCode V2 untuk melanjutkan.",
  ...
  "settings.about.description": "CloseCode, agen pengkodean sumber terbuka",
  "settings.about.trademark": "CloseCode adalah merek dagang terdaftar dari Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Memeriksa CloseCode…",
  "ssh.stage.downloading": "Mengunduh server…",
  "ssh.stage.uploading": "Mengunggah server…",
  "ssh.stage.starting": "Menghubungkan ke CloseCode…",
  ...
  "ssh.error.service": "SSH terhubung, tetapi server CloseCode tidak siap.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Arahkan kamera Anda ke kode QR yang ditampilkan oleh closecode pair.",
  "server.connect.scan.invalid": "Ini bukan kode pemasangan CloseCode. Pindai kode yang ditampilkan oleh closecode pair.",
  ...
  "project.settings.name.description": "Nama yang ditampilkan untuk proyek ini di seluruh CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP yang tersedia untuk CloseCode akan muncul di sini",
  "project.settings.extensions.empty.plugins.title": "Belum ada plugin",
  "project.settings.extensions.empty.plugins.description": "Plugin yang tersedia untuk CloseCode akan muncul di sini",
  "project.settings.extensions.empty.skills.title": "Belum ada keahlian",
  "project.settings.extensions.empty.skills.description": "Keahlian yang tersedia untuk CloseCode akan muncul di sini",
  ...
  "settings.workspaces.empty.description": "Worktree yang dibuat di CloseCode akan muncul di sini",
