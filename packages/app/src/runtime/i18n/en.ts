...
export const dict = {
  ...
  "ssh.stage.checking": "Checking CloseCode…",
  "ssh.stage.downloading": "Downloading server…",
  "ssh.stage.uploading": "Uploading server…",
  "ssh.stage.starting": "Connecting to CloseCode…",
  ...
  "ssh.error.service": "SSH connected, but the CloseCode server did not become ready.",
  "ssh.error.host-key":
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CloseCode",
  ...
  "provider.connect.opencode.name": "CloseCode Console",
  "provider.connect.opencode.freeName": "CloseCode Free",
  "provider.connect.console.title": "Connecting to CloseCode Console",
  ...
  "provider.connect.console.connected": "CloseCode connected",
  ...
  "provider.connect.remote.description":
    "Your CloseCode credentials will be stored on this server. Models will be available through this server.",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CloseCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CloseCode.",
  ...
  "dialog.server.description": "Switch which CloseCode server this app connects to.",
  ...
  "server.connect.link.expired": "This pairing link expired or was already used. Run closecode pair to get a new one.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Checking CloseCode in {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Updating CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Updating CloseCode in {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Update CloseCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install CloseCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CloseCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CloseCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CloseCode.",
  ...
  "server.row.incompatible":
    "This server is running CloseCode {{version}}, which isn't compatible with this app. Upgrade it to CloseCode V2 to continue.",
  ...
  "toast.update.description": "A new version of CloseCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CloseCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CloseCode does not support MCP authentication yet.',
  ...
  "session.error.incompatible.description":
    "{{server}} is running CloseCode {{version}}, which isn't compatible with this app. Upgrade the server to CloseCode V2 to continue.",
  ...
  "sidebar.gettingStarted.line1": "CloseCode includes free models so you can start immediately.",
  ...
  "settings.about.description": "CloseCode, the open source coding agent",
  "settings.about.trademark": "CloseCode is a registered trademark of Anomaly Innovations, Inc.",
  ...
  "settings.desktop.wsl.description": "Run the CloseCode server inside WSL on Windows.",
  ...
  "project.settings.name.description": "The name shown for this project throughout CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs available to CloseCode will appear here",
  "project.settings.extensions.empty.plugins.title": "No plugins yet",
  "project.settings.extensions.empty.plugins.description": "Plugins available to CloseCode will appear here",
  "project.settings.extensions.empty.skills.title": "No skills yet",
  "project.settings.extensions.empty.skills.description": "Skills available to CloseCode will appear here",
  ...
  "settings.general.row.language.description": "Change the display language for CloseCode",
  ...
  "settings.general.row.appearance.description": "Customise how CloseCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CloseCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CloseCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CloseCode launches",
  ...
  "settings.updates.action.download": "Download CloseCode",
  "settings.updates.migration.title": "Move from Beta to Stable",
  "settings.updates.migration.description":
    "For now, CloseCode Beta is moving to CloseCode Stable. Download version {{version}}, then install CloseCode from the disk image to continue receiving updates.",
  "settings.updates.action.installing": "Installing…",
  "settings.updates.toast.latest.title": "You're up to date",
  "settings.updates.toast.latest.description": "You're running the latest version of CloseCode.",
  ...
  "settings.workspaces.empty.description": "Worktrees created in CloseCode will appear here",
