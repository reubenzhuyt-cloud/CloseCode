...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "CloseCode failed to load",
  "desktop.recovery.terminated": "CloseCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "CloseCode is not responding",
