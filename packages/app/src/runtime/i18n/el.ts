export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "CloseCode μενού",
  ...
  "desktop.recovery.loadFailed": "CloseCode απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "CloseCode το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "CloseCode δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο CloseCode.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή CloseCode συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος CloseCode σε {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση CloseCode σε {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση CloseCode σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του CloseCode στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο CloseCode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "CloseCode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το CloseCode.",
  ...
  "toast.update.description": "Μια νέα έκδοση του CloseCode ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα CloseCode",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το CloseCode δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "CloseCode Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή CloseCode μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το CloseCode",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του CloseCode στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το CloseCode ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το CloseCode.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του CloseCode",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του CloseCode.",
  ...
  "server.row.incompatible":
    "Αυτός ο διακομιστής εκτελεί το CloseCode {{version}}, το οποίο δεν είναι συμβατό με αυτήν την εφαρμογή. Αναβαθμίστε τον σε CloseCode V2 για να συνεχίσετε.",
  ...
  "session.error.incompatible.description":
    "Ο διακομιστής {{server}} εκτελεί το CloseCode {{version}}, το οποίο δεν είναι συμβατό με αυτήν την εφαρμογή. Αναβαθμίστε τον διακομιστή σε CloseCode V2 για να συνεχίσετε.",
  ...
  "settings.about.description": "CloseCode, ο παράγοντας κωδικοποίησης ανοιχτού κώδικα",
  "settings.about.trademark": "Το CloseCode είναι σήμα κατατεθέν της Anomaly Innovations, Inc.",
  ...
  "ssh.error.service": "Ο SSH συνδέθηκε, αλλά ο διακομιστής CloseCode δεν ήταν έτοιμος.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Στρέψτε την κάμερά σας στον κωδικό QR που εμφανίζεται από το closecode pair.",
  "server.connect.scan.invalid":
    "Αυτός δεν είναι κωδικός σύζευξης CloseCode. Σαρώστε τον κωδικό που εμφανίζεται από το closecode pair.",
  ...
  "project.settings.name.description": "Το όνομα που εμφανίζεται για αυτό το έργο σε όλο το CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "Το MCPs διαθέσιμο στο CloseCode θα εμφανιστεί εδώ",
  ...
  "project.settings.extensions.empty.plugins.description":
    "Τα πρόσθετα που είναι διαθέσιμα στο CloseCode θα εμφανιστούν εδώ",
  ...
  "project.settings.extensions.empty.skills.description":
    "Οι δεξιότητες που είναι διαθέσιμες στο CloseCode θα εμφανιστούν εδώ",
  ...
  "settings.workspaces.empty.description": "Τα δέντρα εργασίας που δημιουργήθηκαν στο CloseCode θα εμφανιστούν εδώ",
  ...
  "settings.updates.action.download": "Λήψη του CloseCode",
  "settings.updates.migration.title": "Μετάβαση από Beta σε Σταθερή",
  "settings.updates.migration.description":
    "Προς το παρόν, το CloseCode Beta μεταφέρεται στο CloseCode Stable. Κάντε λήψη της έκδοσης {{version}} και, στη συνέχεια, εγκαταστήστε το CloseCode από το είδωλο δίσκου για να συνεχίσετε να λαμβάνετε ενημερώσεις.",
}
