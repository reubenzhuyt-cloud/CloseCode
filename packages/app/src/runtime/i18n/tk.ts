export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "CloseCode menýusy",
  ...
  "desktop.recovery.loadFailed": "CloseCode ýükläp bilmedi",
  "desktop.recovery.terminated": "CloseCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "CloseCode jogap berenok",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we CloseCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini CloseCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini CloseCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy CloseCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode barlamak …",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde CloseCode barlanýar…",
  "wsl.onboarding.updatingOpencode": "CloseCode täzelenmek …",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de CloseCode täzelenmek …",
  "wsl.onboarding.updateOpencodeIn": "CloseCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "CloseCode täzeläň",
  "wsl.onboarding.opencodeReadyIn": "CloseCode {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "CloseCode taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de CloseCode guruň.",
  "wsl.onboarding.installOpencode": "CloseCode guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) CloseCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "CloseCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra CloseCode açyň.",
  ...
  "toast.update.description": "Indi gurmak üçin CloseCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy CloseCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, CloseCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "CloseCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "CloseCode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "CloseCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "CloseCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "CloseCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "CloseCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "CloseCode-iň iň soňky wersiýasyny işleýärsiňiz.",
  ...
  "server.row.incompatible":
    "Bu serwer şu programma bilen gabat gelmeýän CloseCode {{version}} wersiýasyny işledýär. Dowam etmek üçin ony CloseCode V2-ä täzeläň.",
  ...
  "session.error.incompatible.description":
    "{{server}} şu programma bilen gabat gelmeýän CloseCode {{version}} wersiýasyny işledýär. Dowam etmek üçin serweri CloseCode V2-ä täzeläň.",
  ...
  "settings.about.description": "CloseCode, açyk çeşmeli kodlaşdyrma agenti",
  "settings.about.trademark": "CloseCode Anomaly Innovations, Inc. kompaniýasynyň bellige alnan söwda nyşanydyr.",
  ...
  "ssh.error.service": "SSH birikdirildi, ýöne CloseCode serweri taýýar bolmady.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Kamerany closecode pair görkezýän QR koda gönükdiriň.",
  "server.connect.scan.invalid": "Bu CloseCode jübütleme kody däl. closecode pair görkezýän kody skanirläň.",
  ...
  "project.settings.name.description": "CloseCode-da bu taslama üçin görkezilen at",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode üçin elýeterli MCP-ler şu ýerde peýda bolar",
  "project.settings.extensions.empty.plugins.title": "Entek plugin ýok",
  "project.settings.extensions.empty.plugins.description": "CloseCode üçin elýeterli plaginler şu ýerde peýda bolar",
  "project.settings.extensions.empty.skills.title": "Entek başarnyk ýok",
  "project.settings.extensions.empty.skills.description": "CloseCode-da bar bolan başarnyklar şu ýerde peýda bolar",
  ...
  "settings.workspaces.empty.description": "CloseCode-da döredilen iş agaçlary şu ýerde peýda bolar",
  ...
  "settings.updates.action.download": "CloseCode-y ýükläp al",
  "settings.updates.migration.title": "Beta-dan Stable-a geç",
  "settings.updates.migration.description":
    "Häzirlikçe CloseCode Beta CloseCode Stable-a geçýär. Täzelenmeleri almagy dowam etdirmek üçin {{version}} wersiýasyny ýükläp alyň, soňra CloseCode-y disk şekilinden guruň.",
