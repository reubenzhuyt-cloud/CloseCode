export const dict = {
  ...
  "ssh.stage.checking": "Tarkistetaan CloseCode…",
  "ssh.stage.downloading": "Ladataan palvelinta…",
  "ssh.stage.uploading": "Ladataan palvelinta…",
  "ssh.stage.starting": "Yhdistetään laitteeseen CloseCode…",
  ...
  "ssh.error.service": "SSH yhdistetty, mutta CloseCode-palvelin ei tullut valmiiksi.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Suuntaa kamerasi QR-koodiin, joka näkyy closecode pair:ssä.",
  "server.connect.scan.invalid": "Tämä ei ole CloseCode-pariliitoskoodi. Skannaa closecode pair:n näyttämä koodi.",
  ...
  "project.settings.name.description": "Tämän projektin nimi näkyy koko CloseCode:n kautta",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs saatavilla CloseCode näkyy tässä",
  "project.settings.extensions.empty.plugins.title": "Ei vielä lisäosia",
  "project.settings.extensions.empty.plugins.description": "CloseCode:lle saatavilla olevat laajennukset näkyvät täällä",
  "project.settings.extensions.empty.skills.title": "Ei taitoja vielä",
  "project.settings.extensions.empty.skills.description": "CloseCode:n käytettävissä olevat taidot näkyvät täällä",
  ...
  "settings.workspaces.empty.description": "CloseCode:llä luodut työtilat näkyvät täällä",
  ...
  "settings.about.description": "CloseCode, avoimen lähdekoodin koodausagentti",
  "settings.about.trademark": "CloseCode on Anomaly Innovations, Inc:n rekisteröity tavaramerkki.",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CloseCodessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja CloseCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CloseCodessa.",
  ...
  "dialog.server.description": "Vaihda CloseCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan CloseCodea…",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan CloseCodea kohteessa {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Päivitetään CloseCodea…",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään CloseCodea kohteessa {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Päivitä CloseCode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna CloseCode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin CloseCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "CloseCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten CloseCode uudelleen.",
  ...
  "toast.update.description": "CloseCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä CloseCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että CloseCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita CloseCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda CloseCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä CloseCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö CloseCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta CloseCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun CloseCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät CloseCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "CloseCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "CloseCode-valikko",
  ...
  "desktop.recovery.loadFailed": "CloseCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "CloseCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "CloseCode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "CloseCoden asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.opencodeMissing": "CloseCodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "server.row.incompatible":
    "Tässä palvelimessa on käytössä CloseCode {{version}}, joka ei ole yhteensopiva tämän sovelluksen kanssa. Jatka päivittämällä palvelin CloseCode V2:een.",
  ...
  "session.error.incompatible.description":
    "Palvelimessa {{server}} on käytössä CloseCode {{version}}, joka ei ole yhteensopiva tämän sovelluksen kanssa. Jatka päivittämällä palvelin CloseCode V2:een.",
  ...
  "settings.updates.action.download": "Lataa CloseCode",
  "settings.updates.migration.title": "Siirry Betasta vakaaseen versioon",
  "settings.updates.migration.description":
    "CloseCode Beta siirtyy toistaiseksi CloseCode Stableen. Lataa versio {{version}} ja asenna sitten CloseCode levykuvasta, jotta saat jatkossakin päivityksiä.",
}
