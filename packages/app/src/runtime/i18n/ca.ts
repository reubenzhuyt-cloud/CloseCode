export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú CloseCode.",
  ...
  "desktop.recovery.loadFailed": "CloseCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra CloseCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "CloseCode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de CloseCode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.opencodeMissing": "CloseCode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a CloseCode.",
  ...
  "dialog.server.description": "Canvia a quin CloseCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant CloseCode a {{distro}}…",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant CloseCode a {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Actualitza CloseCode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu CloseCode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que CloseCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CloseCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir CloseCode.",
  ...
  "toast.update.description": "Una nova versió de CloseCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip CloseCode.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que CloseCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "CloseCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor CloseCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a CloseCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu CloseCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si CloseCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de CloseCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï CloseCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de CloseCode.",
  ...
  "server.row.incompatible":
    "Aquest servidor executa CloseCode {{version}}, que no és compatible amb aquesta aplicació. Actualitzeu-lo a CloseCode V2 per continuar.",
  ...
  "session.error.incompatible.description":
    "{{server}} executa CloseCode {{version}}, que no és compatible amb aquesta aplicació. Actualitzeu el servidor a CloseCode V2 per continuar.",
  ...
  "settings.about.description": "CloseCode, l'agent de codificació de codi obert",
  "settings.about.trademark": "CloseCode és una marca registrada de Anomaly Innovations, Inc.",
  ...
  "ssh.error.service": "SSH s'ha connectat, però el servidor CloseCode no està preparat.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Apunteu la càmera al codi QR que mostra closecode pair.",
  "server.connect.scan.invalid":
    "Aquest no és un codi d'aparellament CloseCode. Escaneja el codi mostrat per closecode pair.",
  ...
  "project.settings.name.description": "El nom mostrat per a aquest projecte a tot CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs disponible per a CloseCode apareixerà aquí",
  "project.settings.extensions.empty.plugins.title": "Encara no hi ha connectors",
  "project.settings.extensions.empty.plugins.description": "Els connectors disponibles per a CloseCode apareixeran aquí",
  "project.settings.extensions.empty.skills.title": "Encara no hi ha habilitats",
  "project.settings.extensions.empty.skills.description": "Les habilitats disponibles per a CloseCode apareixeran aquí",
  ...
  "settings.workspaces.empty.description": "Els arbres de treball creats a CloseCode apareixeran aquí",
  ...
  "settings.updates.action.download": "Baixa l’CloseCode",
  "settings.updates.migration.title": "Passa de Beta a Estable",
  "settings.updates.migration.description":
    "De moment, CloseCode Beta passa a CloseCode Estable. Baixeu la versió {{version}} i instal·leu l’CloseCode des de la imatge de disc per continuar rebent actualitzacions.",
}
