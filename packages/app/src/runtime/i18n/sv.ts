export const dict = {
  ...
  "ssh.stage.checking": "Kontrollerar CloseCode...",
  "ssh.stage.downloading": "Laddar ner server...",
  "ssh.stage.uploading": "Laddar upp server...",
  "ssh.stage.starting": "Ansluter till CloseCode...",
  ...
  "ssh.error.service": "SSH ansluten, men CloseCode-servern blev inte klar.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Rikta kameran mot QR-koden som visas av closecode pair.",
  "server.connect.scan.invalid": "Detta är inte en CloseCode parningskod. Skanna koden som visas av closecode pair.",
  ...
  "project.settings.name.description": "Namnet som visas för detta projekt i hela CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tillgänglig för CloseCode kommer att visas här",
  "project.settings.extensions.empty.plugins.title": "Inga plugins än",
  "project.settings.extensions.empty.plugins.description": "Plugins tillgängliga för CloseCode kommer att visas här",
  "project.settings.extensions.empty.skills.title": "Inga färdigheter än",
  "project.settings.extensions.empty.skills.description":
    "Färdigheter som är tillgängliga för CloseCode kommer att visas här",
  ...
  "settings.workspaces.empty.description": "Arbetsträd skapade i CloseCode kommer att visas här",
  ...
  "settings.about.description": "CloseCode, kodningsagenten med öppen källkod",
  "settings.about.trademark": "CloseCode är ett registrerat varumärke som tillhör Anomaly Innovations, Inc.",
  ...
  "desktop.recovery.loadFailed": "CloseCode kunde inte läsas in",
  "desktop.recovery.terminated": "CloseCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "CloseCode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av CloseCode misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.opencodeMissing": "CloseCode är inte installerat i den här distributionen",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CloseCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i CloseCode.",
  ...
  "dialog.server.description": "Växla vilken CloseCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar CloseCode i {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Uppdaterar CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar CloseCode i {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera CloseCode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera CloseCode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan CloseCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "CloseCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan CloseCode igen.",
  ...
  "toast.update.description": "En ny version av CloseCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till CloseCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, CloseCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör CloseCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för CloseCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur CloseCode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om CloseCode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa CloseCodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när CloseCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av CloseCode.",
  ...
  "server.row.incompatible":
    "Den här servern kör CloseCode {{version}}, som inte är kompatibelt med den här appen. Uppgradera den till CloseCode V2 för att fortsätta.",
  ...
  "session.error.incompatible.description":
    "{{server}} kör CloseCode {{version}}, som inte är kompatibelt med den här appen. Uppgradera servern till CloseCode V2 för att fortsätta.",
  ...
  "settings.updates.action.download": "Hämta CloseCode",
  "settings.updates.migration.title": "Byt från Beta till Stabil",
  "settings.updates.migration.description":
    "CloseCode Beta flyttas tills vidare till CloseCode Stabil. Hämta version {{version}} och installera sedan CloseCode från skivavbildningen för att fortsätta få uppdateringar.",
}
