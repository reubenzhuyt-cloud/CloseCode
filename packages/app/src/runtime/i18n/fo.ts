export const dict = {
  ...
  "desktop.menu.documentation": "CloseCode Skjøl",
  ...
  "desktop.menu.ariaLabel": "CloseCode valmynd",
  ...
  "desktop.recovery.loadFailed": "CloseCode miseydnaðist at heinta",
  "desktop.recovery.terminated": "CloseCode vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "CloseCode svarar ikki",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í CloseCode.",
  ...
  "dialog.server.description": "Skift hvønn CloseCode ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Kanna CloseCode í {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Dagføring CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring CloseCode í {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Dagfør CloseCode í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set CloseCode upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn CloseCode kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "CloseCode kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani CloseCode aftur.",
  ...
  "toast.update.description": "Ein nýggj útgáva av CloseCode ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til CloseCode toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, CloseCode stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "CloseCode Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr CloseCode ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri CloseCode",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu CloseCode sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um CloseCode fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu CloseCode er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá CloseCode byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av CloseCode.",
  ...
  "server.row.incompatible":
    "Hesin ambætarin koyrir CloseCode {{version}}, sum ikki samsvarar við hetta forritið. Dagfør hann til CloseCode V2 fyri at halda fram.",
  ...
  "session.error.incompatible.description":
    "{{server}} koyrir CloseCode {{version}}, sum ikki samsvarar við hetta forritið. Dagfør ambætaran til CloseCode V2 fyri at halda fram.",
  ...
  "settings.about.description": "CloseCode, opna keldukoduumboðnum",
  "settings.about.trademark": "CloseCode er eitt skrásett vørumerki hjá Anomaly Innovations, Inc.",
  ...
  "ssh.error.service": "SSH varð knýtt, men CloseCode ambætarin gjørdist ikki klárur.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Peika myndatólið á QR-kotuna, sum closecode pair vísir.",
  "server.connect.scan.invalid": "Hetta er ikki ein CloseCode paringarkoda. Skanna kotuna, sum closecode pair vísir.",
  ...
  "project.settings.name.description": "Navnið víst fyri hesa verkætlan í øllum CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCPs tøkt til CloseCode kemur fram her",
  "project.settings.extensions.empty.plugins.title": "Einki tilskot enn",
  "project.settings.extensions.empty.plugins.description": "Plugins, sum eru tøk til CloseCode, koma at síggjast her",
  "project.settings.extensions.empty.skills.title": "Ongin førleiki enn",
  "project.settings.extensions.empty.skills.description": "Førleikar, sum eru tøkir hjá CloseCode, koma fram her",
  ...
  "settings.workspaces.empty.description": "Arbeiðstrø, sum eru stovnað í CloseCode, koma at síggjast her",
  ...
  "settings.updates.action.download": "Tak CloseCode niður",
  "settings.updates.migration.title": "Far úr Beta í Støðugt",
  "settings.updates.migration.description":
    "Í løtuni verður CloseCode Beta flutt til CloseCode Stable. Tak útgávu {{version}} niður og legg síðani CloseCode inn úr diskmyndini fyri framhaldandi at fáa dagføringar.",
}
