export const dict = {
  ...
  "desktop.menu.documentation": "Документация CloseCode",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить CloseCode",
  "desktop.recovery.terminated": "Окно CloseCode неожиданно завершило работу",
  "desktop.recovery.unresponsive": "CloseCode не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить CloseCode",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.opencodeMissing": "CloseCode не установлен в этом дистрибутиве",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode установлен, но его не удалось запустить",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление CloseCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в CloseCode.",
  ...
  "dialog.server.description": "Выберите сервер CloseCode, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Проверка CloseCode в {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Обновление CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Обновление CloseCode в {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Обновите CloseCode в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "CloseCode готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите CloseCode в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в CloseCode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "CloseCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте CloseCode.",
  ...
  "toast.update.description": "Новая версия CloseCode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде CloseCode",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: CloseCode пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер CloseCode внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения CloseCode",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид CloseCode на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли CloseCode системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление CloseCode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске CloseCode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию CloseCode.",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду «closecode».",
  ...
  "server.row.incompatible":
    "На этом сервере работает CloseCode {{version}}, несовместимый с приложением. Чтобы продолжить, обновите его до CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "На сервере {{server}} работает CloseCode {{version}}, несовместимый с приложением. Чтобы продолжить, обновите сервер до CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, агент кодирования с открытым исходным кодом.",
  "settings.about.trademark": "CloseCode является зарегистрированной торговой маркой Anomaly Innovations, Inc..",
  ...
  "ssh.stage.checking": "Проверка CloseCode…",
  "ssh.stage.downloading": "Загрузка сервера…",
  "ssh.stage.uploading": "Загрузка сервера…",
  "ssh.stage.starting": "Подключение к CloseCode…",
  ...
  "ssh.error.service": "SSH подключен, но сервер CloseCode не стал готовым.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "Это не код пары CloseCode. Сканируйте код, показанный парой opencode.",
  ...
  "project.settings.name.description": "Имя, отображаемое для этого проекта во всей системе CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP, доступные для CloseCode, будут отображаться здесь",
  "project.settings.extensions.empty.plugins.title": "Еще нет плагинов",
  "project.settings.extensions.empty.plugins.description": "Плагины, доступные для CloseCode, будут отображаться здесь",
  "project.settings.extensions.empty.skills.title": "Еще нет навыков",
  "project.settings.extensions.empty.skills.description": "Навыки, доступные для CloseCode, будут отображаться здесь",
  ...
  "settings.workspaces.empty.description": "Рабочие деревья, созданные в CloseCode, появятся здесь",
  ...
  "settings.updates.action.download": "Скачать CloseCode",
  "settings.updates.migration.title": "Перейти с Beta на Stable",
  "settings.updates.migration.description":
    "Сейчас CloseCode Beta переходит на CloseCode Stable. Скачайте версию {{version}}, затем установите CloseCode из образа диска, чтобы продолжать получать обновления.",
