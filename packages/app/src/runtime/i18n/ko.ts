export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 CloseCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 CloseCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 CloseCode에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 CloseCode 서버를 전환합니다.",
  ...
  "toast.update.description": "CloseCode의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 CloseCode 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: CloseCode는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 CloseCode 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "CloseCode 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 CloseCode가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "CloseCode가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "CloseCode 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "CloseCode를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 CloseCode를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode 확인 중…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 CloseCode 확인 중…",
  "wsl.onboarding.updatingOpencode": "CloseCode 업데이트 중…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 CloseCode 업데이트 중…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 CloseCode를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "CloseCode 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 CloseCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "CloseCode가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 CloseCode를 설치하세요.",
  "wsl.onboarding.installOpencode": "CloseCode 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CloseCode에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "CloseCode에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 CloseCode를 다시 여세요.",
  ...
  "settings.updates.action.download": "CloseCode 다운로드",
  "settings.updates.migration.title": "베타에서 안정 버전으로 이동",
  "settings.updates.migration.description":
    "현재 CloseCode Beta가 CloseCode 안정 버전으로 이동 중입니다. 계속 업데이트를 받으려면 {{version}} 버전을 다운로드한 다음 디스크 이미지에서 CloseCode를 설치하세요.",
  ...
  "desktop.recovery.loadFailed": "CloseCode를 불러오지 못했습니다",
  "desktop.recovery.terminated": "CloseCode 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "CloseCode가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode 설치 실패",
  "desktop.wsl.error.alreadyAdded": "{{distro}} 배포판은 이미 추가되었습니다",
  "desktop.wsl.error.opencodeMissing": "이 배포판에 CloseCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 CloseCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "CloseCode 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
  ...
  "server.row.incompatible":
    "이 서버에서 실행 중인 CloseCode {{version}}은(는) 이 앱과 호환되지 않습니다. 계속하려면 CloseCode V2로 업그레이드하세요.",
  ...
  "session.error.incompatible.description":
    "{{server}}에서 실행 중인 CloseCode {{version}}은(는) 이 앱과 호환되지 않습니다. 계속하려면 서버를 CloseCode V2로 업그레이드하세요.",
  ...
  "settings.about.description": "오픈소스 코딩 에이전트 CloseCode",
  "settings.about.trademark": "CloseCode는 Anomaly Innovations, Inc.의 등록 상표입니다.",
  ...
  "ssh.stage.checking": "CloseCode 확인 중…",
  "ssh.stage.downloading": "서버 다운로드 중…",
  "ssh.stage.uploading": "서버 업로드 중…",
  "ssh.stage.starting": "CloseCode에 연결 중…",
  "ssh.stage.ready": "연결됨",
  ...
  "ssh.error.service": "SSH에 연결되었지만 CloseCode 서버가 준비되지 않았습니다.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "closecode pair에서 표시된 QR 코드를 카메라로 가리키세요.",
  "server.connect.scan.invalid":
    "이것은 CloseCode 페어링 코드가 아닙니다. CloseCode 페어링에서 표시된 코드를 스캔하세요.",
  ...
  "project.settings.name.description": "CloseCode 전반에서 이 프로젝트에 표시되는 이름",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode에서 사용 가능한 MCP가 여기에 표시됩니다",
  "project.settings.extensions.empty.plugins.title": "아직 플러그인이 없습니다",
  "project.settings.extensions.empty.plugins.description": "CloseCode에서 사용 가능한 플러그인이 여기에 표시됩니다",
  "project.settings.extensions.empty.skills.title": "아직 스킬이 없습니다",
  "project.settings.extensions.empty.skills.description": "CloseCode에서 사용 가능한 스킬이 여기에 표시됩니다",
  ...
  "settings.workspaces.empty.description": "CloseCode에서 생성된 작업 트리가 여기에 표시됩니다",
