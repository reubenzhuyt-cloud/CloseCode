export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja CloseCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać CloseCode",
  "desktop.recovery.terminated": "Okno CloseCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "CloseCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować CloseCode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.opencodeMissing": "Program CloseCode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.opencodeCannotRun": "Program CloseCode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja CloseCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CloseCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CloseCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CloseCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CloseCode.",
  ...
  "dialog.server.description": "Przełącz serwer CloseCode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie CloseCode…",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie CloseCode w dystrybucji {{distro}}…",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie CloseCode…",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie CloseCode w dystrybucji {{distro}}…",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj CloseCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj CloseCode",
  "wsl.onboarding.opencodeReadyIn": "CloseCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "CloseCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj CloseCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj CloseCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim CloseCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "CloseCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz CloseCode.",
  ...
  "toast.update.description": "Nowa wersja CloseCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CloseCode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: CloseCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "CloseCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer CloseCode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CloseCode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd CloseCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CloseCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CloseCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CloseCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CloseCode.",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowano w {{path}}\n\nUruchom terminal ponownie, aby używać polecenia „closecode”.",
  ...
  "server.row.incompatible":
    "Ten serwer korzysta z CloseCode {{version}}, który jest niezgodny z tą aplikacją. Aby kontynuować, uaktualnij go do CloseCode V2.",
  ...
  "session.error.incompatible.description":
    "Serwer {{server}} korzysta z CloseCode {{version}}, który jest niezgodny z tą aplikacją. Aby kontynuować, uaktualnij serwer do CloseCode V2.",
  ...
  "settings.about.description": "CloseCode, agent kodujący typu open source",
  "settings.about.trademark": "CloseCode jest zastrzeżonym znakiem towarowym firmy Anomaly Innovations, Inc.",
  ...
  "ssh.stage.checking": "Sprawdzanie CloseCode…",
  "ssh.stage.downloading": "Pobieranie serwera…",
  "ssh.stage.uploading": "Wgrywanie serwera…",
  "ssh.stage.starting": "Łączenie z CloseCode…",
  ...
  "ssh.error.service": "SSH połączony, ale serwer CloseCode nie stał się gotowy.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.invalid": "To nie jest kod parowania CloseCode. Zeskanuj kod pokazany przez sparowanie opencode.",
  ...
  "project.settings.name.description": "Nazwa wyświetlana dla tego projektu w całym CloseCode",
  ...
  "project.settings.extensions.empty.mcps.description": "MCP dostępne dla CloseCode pojawią się tutaj",
  "project.settings.extensions.empty.plugins.title": "Jeszcze brak wtyczek",
  "project.settings.extensions.empty.plugins.description": "Wtyczki dostępne dla CloseCode pojawią się tutaj",
  "project.settings.extensions.empty.skills.title": "Jeszcze brak umiejętności",
  "project.settings.extensions.empty.skills.description": "Umiejętności dostępne dla CloseCode pojawią się tutaj",
  ...
  "settings.workspaces.empty.description": "Drzewa pracy utworzone w CloseCode pojawią się tutaj",
  ...
  "settings.updates.action.download": "Pobierz CloseCode",
  "settings.updates.migration.title": "Przejdź z Beta na Stable",
  "settings.updates.migration.description":
    "CloseCode Beta jest obecnie przenoszony do CloseCode Stable. Pobierz wersję {{version}}, a następnie zainstaluj CloseCode z obrazu dysku, aby nadal otrzymywać aktualizacje.",
