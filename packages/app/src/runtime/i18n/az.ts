export const dict = {
  ...
  "desktop.recovery.loadFailed": "CloseCode yüklənə bilmədi",
  "desktop.recovery.terminated": "CloseCode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "CloseCode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "CloseCode quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.opencodeMissing": "Bu distribütivdə CloseCode quraşdırılmayıb",
  "desktop.wsl.error.opencodeCannotRun": "CloseCode quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.opencodeNotInstalled": "CloseCode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "CloseCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "CloseCode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və CloseCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "CloseCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və CloseCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və CloseCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu CloseCode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CloseCode yoxlanılır…",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də CloseCode yoxlanılır…",
  "wsl.onboarding.updatingOpencode": "CloseCode yenilənir…",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də CloseCode yenilənir…",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də CloseCode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "CloseCode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "CloseCode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "CloseCode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "CloseCode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "CloseCode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CloseCode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CloseCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "CloseCode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra CloseCode-u yenidən açın.",
  ...
  "toast.update.description": "CloseCode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı CloseCode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: CloseCode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "CloseCode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində CloseCode serverini işlət.",
  ...
  "settings.general.row.language.description": "CloseCode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "CloseCode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "CloseCode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "CloseCode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "CloseCode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "CloseCode-un ən son versiyasından istifadə edirsiniz.",
  ...
  "server.row.incompatible":
    "Bu server bu tətbiqlə uyğun olmayan CloseCode {{version}} versiyasını işlədir. Davam etmək üçün onu CloseCode V2-yə yeniləyin.",
  ...
  "session.error.incompatible.description":
    "{{server}} bu tətbiqlə uyğun olmayan CloseCode {{version}} versiyasını işlədir. Davam etmək üçün serveri CloseCode V2-yə yeniləyin.",
  ...
  "settings.about.description": "CloseCode, açıq mənbəli kodlaşdırma agenti",
  "settings.about.trademark": "CloseCode, Anomaly Innovations, Inc. şirkətinin qeydiyyatdan keçmiş ticarət nişanıdır.",
  ...
  "ssh.stage.checking": "CloseCode yoxlanılır…",
  "ssh.stage.downloading": "Server yüklənir…",
  "ssh.stage.uploading": "Server yüklənir…",
  "ssh.stage.starting": "CloseCode-a qoşulur…",
  ...
  "ssh.error.service": "SSH bağlantısı quruldu, lakin CloseCode serveri hazır vəziyyətə gəlmədi.",
  "ssh.error.host-key":
  ...
  "server.connect.scan.description": "Kameranızı closecode pair tərəfindən göstərilən QR koda yönəldin.",
  "server.connect.scan.invalid": "Bu, CloseCode qoşulma kodu deyil. closecode pair tərəfindən göstərilən kodu skan edin.",
  ...
  "project.settings.name.description": "Bu layihə üçün CloseCode boyunca göstərilən ad",
  ...
  "project.settings.extensions.empty.mcps.description": "CloseCode üçün mövcud MCP-lər burada görünəcək",
  "project.settings.extensions.empty.plugins.title": "Hələ plagin yoxdur",
  "project.settings.extensions.empty.plugins.description": "CloseCode üçün mövcud plaginlər burada görünəcək",
  "project.settings.extensions.empty.skills.title": "Hələ bacarıq yoxdur",
  "project.settings.extensions.empty.skills.description": "CloseCode üçün mövcud bacarıqlar burada görünəcək",
  ...
  "settings.workspaces.empty.description": "CloseCode-da yaradılan iş ağacları burada görünəcək",
  ...
  "settings.updates.action.download": "CloseCode-u endir",
  "settings.updates.migration.title": "Beta-dan Stable-a keçin",
  "settings.updates.migration.description":
    "Hələlik CloseCode Beta, CloseCode Stable-a keçir. Yeniləmələri almağa davam etmək üçün {{version}} versiyasını endirin, sonra CloseCode-u disk obrazından quraşdırın.",
