  ...
  },
  {
    ...
    items: [
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/reubenzhuyt-cloud/CloseCode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://github.com/reubenzhuyt-cloud/CloseCode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
