...
test("opens an investigation draft for a failed MCP server at its originating location", async () => {
  ...
  try {
    ...
    expect(fixture.route.data.prompt?.text).toContain("CloseCode component failed in the current project")
    ...
    expect(fixture.route.data.prompt?.text).toContain("project and global CloseCode configuration")
