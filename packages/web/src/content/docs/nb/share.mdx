...
Delingsfunksjonen i CloseCode lar deg lage offentlige lenker til dine CloseCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruker CloseCode manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
