...
description: Lag verktøy som LLM kan kalle inn CloseCode.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med CloseCode sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
