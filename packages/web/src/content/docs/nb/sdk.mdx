---
title: SDK
description: Typesikker JS-klient for CloseCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

CloseCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere CloseCode programmatisk.
...
Opprett en forekomst av CloseCode:
...
Hvis du allerede har en kjørende forekomst av CloseCode, kan du opprette en klientforekomst for å koble til den:
