---
title: Zen
description: Utvalgt liste over modeller levert av CloseCode.
---
...
CloseCode Zen er en liste over testede og verifiserte modeller levert av CloseCode-teamet.

Zen fungerer som enhver annen leverandør i CloseCode. Du logger inn på CloseCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med CloseCode.
:::
...
CloseCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

CloseCode Zen fungerer som enhver annen leverandør i CloseCode.

1. Du logger inn på **<a href={console}>CloseCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger CloseCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i CloseCode-konfigurasjonen din
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. CloseCode bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Laguna S 2.1 Free er tilgjengelig på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling-3.0-tiny Free er tilgjengelig på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- LongCat-2.0 Free er tilgjengelig på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på CloseCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet CloseCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med CloseCode også.
