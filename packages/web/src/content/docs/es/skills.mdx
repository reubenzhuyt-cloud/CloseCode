...
Las habilidades del agente permiten a CloseCode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
CloseCode busca estas ubicaciones:
...
Para las rutas locales del proyecto, CloseCode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
CloseCode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
