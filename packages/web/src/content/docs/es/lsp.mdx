...
description: CloseCode se integra con sus servidores LSP.
---

CloseCode puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

CloseCode viene con varios servidores LSP integrados para idiomas populares:
