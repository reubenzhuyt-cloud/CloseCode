---
title: Compartir
description: Comparte tus conversaciones CloseCode.
---

La función para compartir de CloseCode te permite crear enlaces públicos a tus conversaciones de CloseCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, CloseCode:
...
CloseCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, CloseCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
