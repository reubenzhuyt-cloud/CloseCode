...
Con CloseCode puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, CloseCode usa nuestro propio tema `closecode`.
...
CloseCode viene con varios temas integrados.
...
- Quiere que CloseCode coincida con la apariencia de su terminal
...
CloseCode admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
