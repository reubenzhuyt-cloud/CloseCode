---
title: Soporte ACP
description: Utilice CloseCode en cualquier editor compatible con ACP.
---

CloseCode admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar CloseCode a través de ACP, configure su editor para ejecutar el comando `closecode acp`.

El comando inicia CloseCode como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'CloseCode' en el selector de agentes de AI Chat.
...
Para usar CloseCode como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar CloseCode como agente ACP para el chat.
...
CloseCode funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración CloseCode
