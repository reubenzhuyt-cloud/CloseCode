---
title: TUI
description: Usando la interfaz de usuario del terminal CloseCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CloseCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar CloseCode se inicia TUI para el directorio actual.
...
Cuando utilice CloseCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a CloseCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de CloseCode. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera CloseCode después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `closecode.default`.
