...
Puede agregar comandos personalizados a través de la configuración CloseCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CloseCode [config](/docs/config):
