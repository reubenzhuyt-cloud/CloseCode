---
title: Web
description: 브라우저에서 CloseCode 사용하기.
---
...
:::tip[Windows 사용자]
최고의 경험을 위해서는 PowerShell보다 `closecode web`를 실행하십시오. 적절한 파일 시스템 액세스 및 terminal 통합을 보장합니다.
:::
...
`closecode`에 대한 사용자의 기본값은 `OPENCODE_SERVER_USERNAME`로 변경할 수 있습니다.
