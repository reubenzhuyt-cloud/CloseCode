...
U CloseCode mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, CloseCode koristi nasu `closecode` temu.
...
CloseCode dolazi sa vise ugradenih tema.
...
- Zele da CloseCode odgovara izgledu njihovog terminala
...
CloseCode podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
