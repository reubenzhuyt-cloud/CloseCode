---
title: Dodaci
description: Napišite vlastite dodatke za proširenje CloseCode.
---

Dodaci vam omogućavaju da proširite CloseCode spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja CloseCode.
...
CloseCode pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje CloseCode.
