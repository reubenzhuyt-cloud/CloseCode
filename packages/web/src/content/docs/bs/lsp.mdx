---
title: LSP serveri
description: CloseCode se integriše sa vašim LSP serverima.
---

CloseCode se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

CloseCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
