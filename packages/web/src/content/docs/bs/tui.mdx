---
title: TUI
description: Korištenje korisničkog interfejsa CloseCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CloseCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje CloseCode pokreće TUI za trenutni direktorij.
...
Kada koristite CloseCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u CloseCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz CloseCode. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo CloseCode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `closecode.default`.
