...
Agent skills omogucavaju CloseCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
CloseCode pretrazuje ove lokacije:
...
Za projektne lokalne putanje, CloseCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
CloseCode navodi dostupne skills u opisu `skill` alata.
