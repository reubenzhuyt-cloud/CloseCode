---
title: ACP podrška
description: Koristite CloseCode u bilo kojem uređivaču kompatibilnom sa ACP.
---

CloseCode podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili CloseCode putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `closecode acp`.

Naredba pokreće CloseCode kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "CloseCode" agenta u AI Chat agent selektoru.
...
Da koristite CloseCode kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi CloseCode kao ACP chat agenta.
...
CloseCode radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj CloseCode konfiguraciji
