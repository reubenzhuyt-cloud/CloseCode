...
تتيح مهارات الوكيل لـ CloseCode اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج CloseCode صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض CloseCode المهارات المتاحة في وصف أداة `skill`.
