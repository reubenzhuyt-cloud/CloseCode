---
title: خوادم LSP
description: يتكامل CloseCode مع خوادم LSP لديك.
---

يمكن أن يتكامل CloseCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي CloseCode مع عدة خوادم LSP مدمجة للغات الشائعة:
