...
مع CloseCode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم CloseCode سمتنا `closecode`.
...
يأتي CloseCode مع عدة سمات مدمجة.
...
- يريدون أن يطابق CloseCode مظهر terminal لديهم
...
يدعم CloseCode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
