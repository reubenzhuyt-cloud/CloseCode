---
title: دعم ACP
description: استخدم CloseCode في أي محرر متوافق مع ACP.
---

يدعم CloseCode بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام CloseCode عبر ACP، اضبط محررك ليشغّل الأمر `closecode acp`.

يشغّل هذا الأمر CloseCode كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'CloseCode' من محدد الوكلاء في AI Chat.
...
لاستخدام CloseCode كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام CloseCode كوكيل ACP للدردشة.
...
يعمل CloseCode عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات CloseCode
