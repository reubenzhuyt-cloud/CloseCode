...
يمكنك إضافة أوامر مخصصة عبر إعدادات CloseCode أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ CloseCode:
