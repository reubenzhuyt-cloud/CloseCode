---
title: TUI
description: استخدام واجهة المستخدم TUI في CloseCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر CloseCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل CloseCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة CloseCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى CloseCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من CloseCode. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار CloseCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `closecode.default`.
