...
CloseCode Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o CloseCode Zen.
:::

1. Execute o comando `/connect` no TUI, selecione `CloseCode Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
CloseCode Go é um plano de assinatura de baixo custo que fornece acesso confiável a modelos de codificação abertos populares fornecidos pela equipe do opencode que foram
testados e verificados para funcionar bem com o opencode.

1. Execute o comando `/connect` no TUI, selecione `CloseCode Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
Ele está configurado para usar gpt-5-nano por padrão, hospedado pela Zen. Para bloquear o closecode
...
CloseCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>CloseCode Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **CloseCode Zen**.
...
1. **Verifique a configuração de autenticação**: Execute `closecode auth list` para ver se as credenciais
