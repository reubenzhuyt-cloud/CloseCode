...
- `leader_timeout` - Controla por quanto tempo o CloseCode espera depois da leader key. O padrão é `2000`.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `closecode.default`.
