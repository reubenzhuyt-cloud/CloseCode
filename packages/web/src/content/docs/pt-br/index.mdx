...
- **Usando Homebrew no macOS e Linux**
  ...
  > Recomendamos usar o tap do opencode para as versões mais atualizadas. A fórmula oficial `brew install closecode` é mantida pela equipe do Homebrew e é atualizada com menos frequência.
...
Você também pode baixar o binário na seção [Releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases).
...
Se você é novo no uso de provedores de LLM, recomendamos usar o [CloseCode Zen](/docs/zen).
