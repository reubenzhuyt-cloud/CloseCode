---
title: Share
description: Share your CloseCode conversations.
---

CloseCode's share feature allows you to create public links to your CloseCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, CloseCode:
...
CloseCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, CloseCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
