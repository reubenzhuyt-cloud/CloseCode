...
Vous pouvez ajouter des commandes personnalisées via la configuration CloseCode ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre CloseCode [config](/docs/config) :
