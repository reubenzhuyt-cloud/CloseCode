...
Les compétences d'agent permettent à CloseCode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
CloseCode recherche ces emplacements :
...
Pour les chemins locaux du projet, CloseCode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
CloseCode répertorie les compétences disponibles dans la description de l'outil `skill`.
