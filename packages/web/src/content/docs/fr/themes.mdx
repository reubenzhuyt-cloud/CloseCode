...
Avec CloseCode, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, CloseCode utilise notre propre thème `closecode`.
...
CloseCode est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que CloseCode corresponde à l'apparence de leur terminal
...
CloseCode prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
