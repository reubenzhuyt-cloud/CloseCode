...
- **Использование Homebrew в macOS и Linux**
  ...
  > Мы рекомендуем использовать tap opencode для получения самых последних версий. Официальная формула `brew install closecode` поддерживается командой Homebrew и обновляется реже.
...
Вы также можете получить бинарный файл в разделе [Releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases).
...
Если вы новичок в использовании поставщиков LLM, мы рекомендуем использовать [CloseCode Zen](/docs/zen).
