...
description: CloseCode, LSP sunucularınızla bütünleşir.
---

CloseCode, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

CloseCode, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
