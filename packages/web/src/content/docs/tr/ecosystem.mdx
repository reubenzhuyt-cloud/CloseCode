---
title: Ekosistem
description: CloseCode ile geliştirilen projeler ve entegrasyonlar.
---

CloseCode üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
CloseCode ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | CloseCode oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile CloseCode kullanımını takip edin                                                                                  |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | CloseCode oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | CloseCode bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | CloseCode aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | CloseCode için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | CloseCode için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, CloseCode oturumlarını kontrol eden Discord botu       |
...
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden CloseCode için mobil öncelikli web arayüzü               |
| [closecode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | CloseCode eklentileri oluşturmak için şablon                                     |
...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla CloseCode kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | CloseCode için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [CloseCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | CloseCode'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | CloseCode tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip CloseCode eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | CloseCode için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
