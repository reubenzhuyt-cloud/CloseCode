...
opencode'u ACP aracılığıyla kullanmak için düzenleyicinizi `closecode acp` komutunu çalıştıracak şekilde yapılandırın.
...
Açmak için AI Chat agent seçicisindeki yeni 'CloseCode' ajanını kullanın.
