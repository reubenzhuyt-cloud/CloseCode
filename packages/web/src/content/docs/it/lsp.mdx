---
title: Server LSP
description: CloseCode si integra con i tuoi server LSP.
---

CloseCode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

CloseCode include diversi server LSP integrati per linguaggi popolari:
