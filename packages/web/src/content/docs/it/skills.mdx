...
Le skill degli agenti permettono a CloseCode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
CloseCode cerca in queste posizioni:
...
Per i percorsi locali al progetto, CloseCode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
CloseCode elenca le skill disponibili nella descrizione dello strumento `skill`.
