...
- **Korzystanie z Homebrew na macOS i Linux**
  ...
  > W celu uzyskania najbardziej aktualnej wersji zalecamy korzystanie z opencode. Oficjalna formuła `brew install closecode` jest utrzymywana przez zespół Homebrew i jest aktualizowana.
...
Możesz także pobrać plik binarny z [Releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases).
...
Jeśli będziesz korzystać z wielu dostawców LLM, zalecamy skorzystanie z [CloseCode Zen](/docs/zen).
