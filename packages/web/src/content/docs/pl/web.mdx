...
:::tip[Windows Users]
Aby uzyskać najlepsze wyniki, uruchom `closecode web` z [WSL](/docs/windows-wsl) zamiast programu PowerShell. Zapewnia to prawidłowy dostęp do systemu plików i integrację terminala.
:::
...
Domyślna nazwa użytkownika to `closecode`, ale można ją zmienić za pomocą `OPENCODE_SERVER_USERNAME`.
