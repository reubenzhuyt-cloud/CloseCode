...
opencode integruje się z VS Code, Cursorem lub obsługującym terminal IDE. Aby uruchomić, po prostu uruchom `closecode` w terminalu.
...
3. Uruchom `closecode` — rozszerzenie instaluje się automatycznie
...
- zastosowanie się, że użycie `closecode` w terminalu.
