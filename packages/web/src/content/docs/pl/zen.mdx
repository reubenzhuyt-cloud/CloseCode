---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez CloseCode.
---
...
CloseCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół CloseCode.

Zen działa jak każdy inny dostawca w CloseCode. Logujesz się do CloseCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z CloseCode.
:::
...
CloseCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

CloseCode Zen działa jak każdy inny dostawca w CloseCode.

1. Logujesz się do **<a href={console}>CloseCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz CloseCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji CloseCode używa formatu
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. CloseCode używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Laguna S 2.1 Free jest dostępny w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling-3.0-tiny Free jest dostępny w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- LongCat-2.0 Free jest dostępny w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w CloseCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy CloseCode Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w CloseCode także dowolnego innego dostawcy.
