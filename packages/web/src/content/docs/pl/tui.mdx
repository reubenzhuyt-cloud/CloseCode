...
- `leader_timeout` - Określa, jak długo CloseCode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `closecode.default`.
