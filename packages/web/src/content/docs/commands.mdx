...
You can add custom commands through the CloseCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your CloseCode [config](/docs/config):
