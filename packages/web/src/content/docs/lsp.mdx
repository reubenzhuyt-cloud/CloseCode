---
title: LSP Servers
description: CloseCode integrates with your LSP servers.
---

CloseCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

CloseCode comes with several built-in LSP servers for popular languages:
