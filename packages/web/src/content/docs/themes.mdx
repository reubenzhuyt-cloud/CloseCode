...
With CloseCode you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, CloseCode uses our own `closecode` theme.
...
CloseCode comes with several built-in themes.
...
- Want CloseCode to match their terminal's appearance
...
CloseCode supports a flexible JSON-based theme system that allows users to create and customize themes easily.
