---
title: LSP Server
description: CloseCode lässt sich in Ihren LSP-Server integrieren.
---

CloseCode kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

CloseCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und CloseCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer CloseCode-Konfiguration aktivieren und anpassen.
