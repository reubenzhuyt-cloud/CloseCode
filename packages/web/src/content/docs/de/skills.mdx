...
Agent Skills erlauben CloseCode, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
CloseCode sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft CloseCode vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
CloseCode listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
