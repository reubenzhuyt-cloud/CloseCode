...
Mit CloseCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet CloseCode das `closecode`-Theme.
...
CloseCode liefert mehrere eingebaute Themes mit.
...
- CloseCode optisch ans Terminal anpassen wollen
...
CloseCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
