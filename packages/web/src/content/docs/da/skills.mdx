...
Agentferdigheter lar CloseCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
CloseCode søker etter disse stedene:
...
For prosjektlokale stier går CloseCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
CloseCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
