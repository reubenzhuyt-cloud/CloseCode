---
title: Zen
description: Udvalgt liste over modeller leveret af CloseCode.
---
...
CloseCode Zen er en liste over testede og verificerede modeller leveret af CloseCode-teamet.

Zen fungerer som enhver anden udbyder i CloseCode. Du logger ind på CloseCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med CloseCode.
:::
...
CloseCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

CloseCode Zen fungerer som enhver anden udbyder i CloseCode.

1. Du logger ind på **<a href={console}>CloseCode Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger CloseCode Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din CloseCode-konfiguration
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. CloseCode bruger disse modeller til at generere sessionstitler.
...
- DeepSeek V4 Flash Free er tilgængelig på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Laguna S 2.1 Free er tilgængelig på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling-3.0-tiny Free er tilgængelig på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- LongCat-2.0 Free er tilgængelig på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på CloseCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte CloseCode Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med CloseCode også.
