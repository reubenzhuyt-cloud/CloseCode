...
Du kan tilføje brugerdefinerede kommandoer gennem CloseCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din CloseCode [config](/docs/config):
