---
title: Deling
description: Del dine CloseCode-samtaler.
---

CloseCodes delingsfunksjon lar deg lage offentlige lenker til dine CloseCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, CloseCode:
...
CloseCode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger CloseCode manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
