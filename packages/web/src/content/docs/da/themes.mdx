...
Med CloseCode kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger CloseCode vårt eget `closecode`-tema.
...
CloseCode kommer med flere innebygde temaer.
...
- Vil at CloseCode skal matche terminalens utseende
...
CloseCode støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
