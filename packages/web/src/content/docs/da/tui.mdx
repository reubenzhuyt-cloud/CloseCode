---
title: TUI
description: Brug af CloseCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CloseCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre CloseCode starter TUI for den nuværende mappe.
...
Når du bruger CloseCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til CloseCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut CloseCode. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe CloseCode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `closecode.default`.
