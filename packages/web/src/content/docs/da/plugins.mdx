---
title: Plugins
description: Skriv dine egne plugins for at udvide CloseCode.
---

Plugins giver dig mulighed for at udvide CloseCode ved at tilslutte sig forskellige begivenheder og tilpasse adfærd. Du kan oprette plugins for at tilføje nye funktioner, integrere med eksterne tjenester eller ændre CloseCodes standardadfærd.
...
CloseCode kører `bun install` ved opstart for at installere disse. Dine plugins og værktøjer kan derefter importere dem.
...
:::note
Hvis du bruger CloseCode desktop-appen, kan den sende systemmeddelelser automatisk, når et svar er klar, eller når en session fejler.
:::
