...
const stages = ["Keeping your session safe", "Starting the new background service", "Loading CloseCode"] as const
...
function UpdateFooter(props: {
  ...
  const pausedHeader = phrase(["CloseCode", colors.muted, true], ["update paused", colors.muted])
  const outcomeStatus = () =>
