...
nix run nixpkgs#opencode           # або github:reubenzhuyt-cloud/CloseCode для найновішої dev-гілки
```
...
CloseCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/reubenzhuyt-cloud/CloseCode/releases) або [github.com/reubenzhuyt-cloud/CloseCode/releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases).
...
CloseCode містить два вбудовані агенти, між якими можна перемикатися клавішею `Tab`.
...
Щоб дізнатися більше про налаштування CloseCode, [**перейдіть до нашої документації**](https://opencode.ai/docs).

### Внесок

Якщо ви хочете зробити внесок в CloseCode, будь ласка, прочитайте нашу [документацію для контриб'юторів](./CONTRIBUTING.md) перед надсиланням pull request.

### Проєкти на базі CloseCode

Якщо ви працюєте над проєктом, пов'язаним з CloseCode, і використовуєте "opencode" у назві, наприклад "opencode-dashboard" або "opencode-mobile", додайте примітку до свого README.
Уточніть, що цей проєкт не створений командою CloseCode і жодним чином не афілійований із нами.
