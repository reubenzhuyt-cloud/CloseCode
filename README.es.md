...
nix run nixpkgs#opencode           # o github:reubenzhuyt-cloud/CloseCode para la rama dev más reciente
```
...
CloseCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases) o desde [github.com/reubenzhuyt-cloud/CloseCode/releases](https://github.com/reubenzhuyt-cloud/CloseCode/releases).
...
CloseCode incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Para más información sobre cómo configurar CloseCode, [**ve a nuestra documentación**](https://opencode.ai/docs).

### Contribuir

Si te interesa contribuir a CloseCode, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en CloseCode

Si estás trabajando en un proyecto basado en CloseCode y usas "opencode" como parte del nombre, por ejemplo, "opencode-dashboard" u "opencode-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de CloseCode y que no está afiliado con nosotros de ninguna manera.
