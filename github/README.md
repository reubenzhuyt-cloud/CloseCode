   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
           uses: reubenzhuyt-cloud/CloseCode/github@latest
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/reubenzhuyt-cloud/CloseCode/issues.
